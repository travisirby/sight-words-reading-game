...
void main() {
    ...
    </div>`,document.body.appendChild(qf);let e=new gl({alpha:!0,antialias:!0});e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setSize(96,96),e.outputColorSpace=Ve,qf.querySelector(`.fairy-bob`).prepend(e.domElement);let t=new yn,n=new Ea(38,1,.1,20);n.position.set(0,.15,3.4),n.lookAt(0,0,0),t.add(new Aa(16777215,.85));let r=new ka(16777215,1.6);r.position.set(2,4,5),t.add(r);let i=Kf();t.add(i.group);let a=0,o=!1;e.setAnimationLoop(()=>{let r=1/60;a+=r;let s=Math.sin(a*(Yf?38:11))*.3+.25;i.wingL.rotation.y=-s,i.wingR.rotation.y=s,i.group.rotation.y=-.3+Math.sin(a*.7)*.18,i.star.rotation.z+=r*(Yf?9:1.2);let c=Yf&&Math.sin(a*16)>0;c!==o&&(o=c,i.face.map=c?i.faceOpen:i.faceClosed,i.face.needsUpdate=!0),i.legL.rotation.x=Math.sin(a*2.1)*.18,i.legR.rotation.x=Math.sin(a*2.1+1.4)*.18,e.render(t,n)}),window.addEventListener(`wr-speech`,e=>{Yf=!!e.detail.speaking,qf.classList.toggle(`speaking`,Yf)})}function Zf(e){if(!qf)return;let t=Lf[e];t&&(t.x!==Jf&&qf.classList.toggle(`face-left`,t.x<Jf),Jf=t.x,qf.style.left=`${t.x}%`,qf.style.top=`${t.y}%`)}var Qf=[{id:`rug`,name:`Cozy Rug`,emoji:`🟥`,cost:25,currency:`coins`},{id:`chair`,name:`Comfy Chair`,emoji:`🪑`,cost:35,currency:`coins`},{id:`table`,name:`Table`,emoji:`🍽️`,cost:45,currency:`coins`},{id:`bed`,name:`Big Kid Bed`,emoji:`🛏️`,cost:60,currency:`coins`},{id:`lamp`,name:`Lamp`,emoji:`💡`,cost:50,currency:`coins`},{id:`bookshelf`,name:`Bookshelf`,emoji:`📚`,cost:80,currency:`coins`},{id:`toybox`,name:`Toy Box`,emoji:`🧸`,cost:90,currency:`coins`},{id:`flowers`,name:`Flower Bed`,emoji:`🌷`,cost:40,currency:`coins`},{id:`mailbox`,name:`Mailbox`,emoji:`📬`,cost:55,currency:`coins`},{id:`tree`,name:`Shady Tree`,emoji:`🌳`,cost:75,currency:`coins`},{id:`swing`,name:`Swing Set`,emoji:`🛝`,cost:120,currency:`coins`},{id:`trampoline`,name:`Trampoline`,emoji:`🤸`,cost:150,currency:`coins`},{id:`cat`,name:`Pet Cat`,emoji:`🐱`,cost:20,currency:`gems`},{id:`dog`,name:`Pet Dog`,emoji:`🐶`,cost:30,currency:`gems`},{id:`aquarium`,name:`Fish Tank`,emoji:`🐠`,cost:40,currency:`gems`},{id:`telescope`,name:`Telescope`,emoji:`🔭`,cost:55,currency:`gems`},{id:`robot`,name:`Robot Buddy`,emoji:`🤖`,cost:70,currency:`gems`},{id:`rocket`,name:`Rocket Ship`,emoji:`🚀`,cost:100,currency:`gems`}],$=e=>document.getElementById(e),$f=[`title`,`map`,`pause`,`complete`,`bonus`,`char`,`house`];function ep(e){Xf(),tp($(`btn-play`),`Play!`,()=>e.onPlay()),tp($(`btn-character`),`Make your character!`,()=>e.onCharacter()),tp($(`btn-char-back`),`Back`,()=>e.onCharacterDone()),tp($(`btn-char-done`),`Looking good!`,()=>e.onCharacterDone()),tp($(`btn-settings`),`Settings`,()=>$(`settings-panel`).classList.toggle(`hidden`)),tp($(`btn-settings-close`),`Close`,()=>$(`settings-panel`).classList.add(`hidden`)),tp($(`btn-toggle-sound`),`Sound`,()=>e.onToggleSound()),tp($(`btn-toggle-mic`),`Mic round`,()=>e.onToggleMic()),tp($(`btn-map-back`),`Back`,()=>e.onMapBack()),tp($(`btn-banner-play`),`Here we go!`,()=>e.onBannerPlay()),tp($(`btn-pause`),`Pause`,()=>e.onPause()),tp($(`btn-resume`),`Resume`,()=>e.onResume()),tp($(`btn-pause-map`),`Map`,()=>e.onPauseMap()),$(`btn-repeat-word`).addEventListener(`click`,()=>e.onRepeatWord()),tp($(`btn-play-again`),`Play again!`,()=>e.onPlayAgain()),tp($(`btn-next-level`),`Next level!`,()=>e.onNextLevel()),tp($(`btn-complete-map`),`Map`,()=>e.onCompleteMap()),tp($(`btn-bonus-skip`),`Skip`,()=>e.onBonusSkip()),tp($(`btn-title-house`),`My house!`,()=>e.onHouse(`title`)),tp($(`btn-complete-house`),`My house!`,()=>e.onHouse(`complete`)),tp($(`btn-house-back`),`Back`,()=>e.onHouseBack()),tp($(`btn-house-shop`),`Shop!`,()=>xp(!0)),tp($(`btn-shop-close`),`Close`,()=>xp(!1)),yp=e.onBuyItem,np($(`btn-mic`),e.onMicDown,e.onMicUp),np($(`btn-move-left`),()=>e.onMoveDown(-1),()=>e.onMoveUp(-1)),np($(`btn-move-right`),()=>e.onMoveDown(1),()=>e.onMoveUp(1)),np($(`btn-move-jump`),e.onJumpDown,e.onJumpUp);let t=0;$(`version-tag`).addEventListener(`click`,()=>{t++,t>=5&&(t=0,e.onDevUnlock())})}function tp(e,t,n){e.addEventListener(`click`,()=>{mu(t,{rate:1}),n()})}function np(e,t,n){let r=e=>{e.preventDefault(),t()},i=e=>{e.preventDefault(),n()};e.addEventListener(`touchstart`,r,{passive:!1}),e.addEventListener(`touchend`,i,{passive:!1}),e.addEventListener(`touchcancel`,i,{passive:!1}),e.addEventListener(`mousedown`,r),e.addEventListener(`mouseup`,i),e.addEventListener(`mouseleave`,i)}function rp(e){for(let t of $f)$(`screen-${t}`).classList.toggle(`hidden`,t!==e);e!==`map`&&sp(),Zf(e||`game`)}function ip(e){$(`hud`).classList.toggle(`hidden`,!e)}function ap(){let e=xu();$(`btn-toggle-sound`).textContent=e.sound?`🔊 Sound: ON`:`🔇 Sound: OFF`,$(`btn-toggle-mic`).textContent=e.mic?`🎤 Mic Round: ON`:`🎤 Mic Round: OFF`}function op({name:e,stars:t,completed:n,secret:r,boss:i}){$(`banner-name`).textContent=r?`✨ ${e} ✨`:i?`👑 ${e} 👑`:e,$(`banner-stars`).textContent=t>0?`⭐`.repeat(t):`· · ·`,$(`btn-banner-play`).textContent=n?`🔁 PLAY`:`▶️ PLAY`,$(`level-banner`).classList.remove(`hidden`)}function sp(){$(`level-banner`).classList.add(`hidden`)}function cp(){return!$(`level-banner`).classList.contains(`hidden`)}function lp(e){let t=$(`char-rows`);t.innerHTML=``;let n=xu().character,r=(e,n)=>{let r=document.createElement(`div`);r.className=`char-row`;let i=document.createElement(`div`);i.className=`char-label`,i.textContent=e,r.appendChild(i);let a=document.createElement(`div`);a.className=`char-options`;for(let e of n)a.appendChild(e);r.appendChild(a),t.appendChild(r)},i=(t,n,r)=>{mu(r,{rate:1}),e(t,n),lp(e)};for(let[e,t]of Object.entries(Yu))r(t.label,t.colors.map((r,a)=>{let o=document.createElement(`button`);return o.className=`swatch`+(a===n[e]?` selected`:``),o.style.background=`#${r.toString(16).padStart(6,`0`)}`,o.addEventListener(`click`,()=>i(e,a,t.names[a])),o}));let a=(e,t,n)=>r(t.label,t.names.map((r,a)=>{let o=document.createElement(`button`);return o.className=`swatch style-swatch`+(a===n?` selected`:``),o.textContent=t.icons[a],o.title=r,o.addEventListener(`click`,()=>i(e,a,r)),o}));a(`style`,Xu,n.style),a(`outfit`,Zu,n.outfit)}function up(e){$(`coin-count`).textContent=e}function dp(e){$(`hud-key`).classList.toggle(`hidden`,!e)}function fp(e){$(`move-controls`).classList.toggle(`hidden`,!e)}function pp(e){let t=$(`progress-dots`);t.innerHTML=``;for(let n=0;n<e;n++){let e=document.createElement(`div`);e.className=`dot`,t.appendChild(e)}}function mp(e,t){let n=$(`progress-dots`).children[e];n&&(n.className=`dot ${t}`)}function hp({stars:e,coins:t,gems:n,hasNext:r}){rp(`complete`),$(`complete-coins`).textContent=t,$(`complete-gems`).textContent=n,$(`btn-next-level`).classList.toggle(`hidden`,!r);let i=$(`star-row`).querySelectorAll(`.star`);i.forEach(e=>e.classList.remove(`earned`));for(let t=0;t<e;t++)setTimeout(()=>i[t].classList.add(`earned`),500+t*450)}function gp(e){$(`bonus-word`).textContent=e,$(`bonus-feedback`).textContent=``}function _p(e){$(`bonus-feedback`).textContent=e}function vp(e){$(`btn-mic`).classList.toggle(`listening`,e)}var yp=null,bp=null;function xp(e){$(`shop-panel`).classList.toggle(`hidden`,!e),e&&wp()}function Sp(){rp(`house`),xp(!1),Cp()}function Cp(){let e=xu();$(`house-coins`).textContent=e.coins,$(`house-gems`).textContent=e.gems}function wp(){Cp();let e=xu(),t=$(`shop-list`);t.innerHTML=``;for(let n of Qf){let r=Iu(n.id),i=n.currency===`gems`?e.gems:e.coins,a=document.createElement(`button`);a.className=`shop-item`+(r?` owned`:i<n.cost?` cant-afford`:``);let o=n.currency===`gems`?`💎`:`🪙`;a.innerHTML=`<span class="shop-emoji">${n.emoji}</span>
      <span class="shop-info"><span>${n.name}</span>
      <span class="shop-cost">${r?`✅ Got it!`:`${o} ${n.cost}`}</span></span>`,a.addEventListener(`click`,()=>yp&&yp(n)),t.appendChild(a)}}function Tp(e){let t=$(`house-toast`);t.textContent=e,t.classList.remove(`hidden`),clearTimeout(bp),bp=setTimeout(()=>t.classList.add(`hidden`),1800)}var Ep=window.webkitSpeechRecognition||window.SpeechRecognition||null,Dp=null,Op=!1;function kp(){return!!Ep}function Ap(e,t){if(!Ep||Op)return!1;try{return Dp=new Ep,Dp.lang=`en-US`,Dp.interimResults=!0,Dp.maxAlternatives=5,Dp.continuous=!1,Dp.onresult=t=>{let n=[];for(let e=0;e<t.results.length;e++){let r=t.results[e];for(let e=0;e<r.length;e++){let t=(r[e].transcript||``).toLowerCase().replace(/[^a-z'\s]/g,``);for(let e of t.split(/\s+/))e&&n.push(e)}}n.length&&e&&e(n)},Dp.onerror=()=>jp(t),Dp.onend=()=>jp(t),Dp.start(),Op=!0,!0}catch{return jp(t),!1}}function jp(e){Op&&(Op=!1,Dp=null,e&&e())}function Mp(){if(Dp)try{Dp.stop()}catch{}Op=!1}var Np=new URLSearchParams(location.search);Np.has(`reset`)&&Wu(),yu(),Np.has(`unlock`)&&Gu(gd.length),Fl(!xu().sound);var Pp=gd.map(e=>e.levels.length),Fp={world:0,level:0,secret:!1},Ip=null,Lp=null,Rp=null,zp=`map`,Bp=`title`,Vp=()=>Pl();window.addEventListener(`pointerdown`,Vp,{once:!0}),window.addEventListener(`touchstart`,Vp,{once:!0});var Hp=document.getElementById(`game-container`),Up=new gl({antialias:!0});Up.setPixelRatio(Math.min(window.devicePixelRatio,2)),Up.setSize(window.innerWidth,window.innerHeight),Up.outputColorSpace=Ve,Hp.appendChild(Up.domElement);var Wp=new nf(Up,{onCoins:e=>up(e),onDotsInit:e=>pp(e),onDot:(e,t)=>mp(e,t),onKey:e=>dp(e),onChoice:e=>fp(e),onRunComplete:e=>sm(e)}),Gp=new xf(Up,{onNodeSelected:e=>{Ip=e,mu(e.name,{rate:1}),op(e)},onDismiss:()=>{Ip=null,sp()},onEnterKey:()=>{Ip&&cp()?im():Gp.walkTo(Gp.tokenNav)},onHouseTapped:()=>{mu(`My house!`,{rate:1}),em(`map`)},onEditTapped:()=>{mu(`Make your character!`,{rate:1}),Qp(`map`)}}),Kp=new Sf,qp=new If(Up);window.__wr={game:Wp,store:hu,map:Gp,charScene:Kp,house:qp};var Jp=new Za;Up.setAnimationLoop(()=>{let e=Math.min(Jp.getDelta(),.05);zp===`game`?(Wp.tick(e),Up.render(Wp.scene,Wp.camera)):zp===`char`?(Kp.tick(e),Up.render(Kp.scene,Kp.camera)):zp===`house`?(qp.tick(e),Up.render(qp.scene,qp.camera)):(Gp.tick(e),Up.render(Gp.scene,Gp.camera))});function Yp(){for(let e of[Wp.camera,Gp.camera,Kp.camera,qp.camera])e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix();Up.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,Yp),window.addEventListener(`orientationchange`,Yp);function Xp(){zp=`map`,Gp.enter(),ip(!1),rp(`map`)}var Zp=`title`;function Qp(e=`title`){Zp=e,zp===`map`&&Gp.exit(),zp=`char`,Kp.setLook(ud()),lp((e,t)=>{Ku(e,t),Kp.setLook(ud())}),rp(`char`)}function $p(){let e=ud();if(dd(Wp.player.group,e),dd(Gp.token,e),Zp===`map`){Xp();return}zp=`map`,rp(`title`)}function em(e){Bp=e,zp===`map`&&Gp.exit(),zp=`house`,qp.enter(),ip(!1),Sp()}function tm(){qp.exit(),Bp===`complete`?lm():Bp===`map`?Xp():(zp=`map`,rp(`title`))}function nm(e){if(Iu(e.id)){mu(`You already have the ${e.name}!`,{rate:1});return}if(!Lu(e.id,e.cost,e.currency)){let t=e.currency===`gems`?`gems — try the bonus round`:`coins`;Tp(`🪙 Keep playing!`),mu(`You need more ${t}! Play levels to earn more.`,{rate:1});return}qp.refresh(),qp.celebrate(e.id),Bl(),wp(),Tp(`${e.emoji} ${e.name}!`),mu(`You got the ${e.name}! ${Cd[Math.random()*Cd.length|0]}`,{rate:1})}function rm(e,t,n=!1){let r=!n&&t===Pp[e];Fp={world:e,level:t,secret:n,boss:r},Gp.exit(),zp=`game`,Wp.startRun(e,t,{secret:n,boss:r}),rp(null),ip(!0)}function im(){if(!Ip)return;let e=Ip;Ip=null,sp(),rm(e.world,e.secret?0:e.level,e.secret)}function am(e,t){return t+1<=Pp[e]?{world:e,level:t+1}:e+1<gd.length?{world:e+1,level:0}:null}function om(e){let t=e.length||1,n=e.filter(e=>e.firstTry).length;return n===t?3:n/t>=.7?2:1}function sm(e){Lp=e,ip(!1);let t=om(e.results);if(Lp.stars=t,Fp.secret)ju(Fp.world,t);else{let n=Ou(Fp.world,Fp.level)===0;if(ku(Fp.world,Fp.level,t),Vu(Fp.world,Fp.level,Pp),Fp.boss&&Bu(Fp.world),n){let e=am(Fp.world,Fp.level);e&&Hu(e.world,e.level)&&Gp.queueReveal({kind:`node`,world:e.world,level:e.level})}e.keyFound&&!Mu(Fp.world,Fp.level)&&(Nu(Fp.world,Fp.level),Gp.queueReveal({kind:`secret`,world:Fp.world}))}kp()&&xu().mic&&e.results.length?um(e):cm()}function cm(){let e=Fp.secret?null:am(Fp.world,Fp.level);hp({stars:Lp.stars,coins:Lp.coins,gems:Lp.gems,hasNext:!!e&&Hu(e.world,e.level)})}function lm(){Xp(),Gp.setTokenTo(Fp.world,Fp.level,Fp.secret)}function um(e){try{Rp={words:vd(e.results.map(e=>e.word)).slice(0,3),idx:0,matched:!1,heard:[],advancing:!1},rp(`bonus`),mu(`Bonus round! Read the word out loud. Hold the microphone and say it!`,{rate:1}),dm()}catch{pm()}}function dm(){Rp.matched=!1,Rp.heard=[],Rp.advancing=!1,gp(Rp.words[Rp.idx])}function fm(){!Rp||Rp.advancing||(Rp.advancing=!0,Mp(),vp(!1),setTimeout(()=>{Rp&&(Rp.idx++,Rp.idx>=Rp.words.length?pm():dm())},1400))}function pm(){Rp=null,Mp(),vp(!1),cm()}function mm(e){return(e||``).toLowerCase().replace(/[^a-z']/g,``)}function hm(){if(!Rp||Rp.advancing)return;let e=mm(Rp.words[Rp.idx]);Ap(t=>{!Rp||Rp.matched||(Rp.heard.push(...t),t.some(t=>mm(t)===e)&&(Rp.matched=!0,Rp.heard=[],Lp.gems+=5,Du(5),Bl(),_p(`⭐ +5 💎`),mu(Cd[Math.random()*Cd.length|0],{rate:1}),fm()))},()=>{vp(!1),!(!Rp||Rp.matched||Rp.advancing)&&Rp.heard.length&&(_p(`💛 Nice try!`),mu(`Nice try! The word is: ${Rp.words[Rp.idx]}`,{rate:.9}),fm())})&&vp(!0)}function gm(){Mp(),vp(!1)}ep({onPlay:()=>{Xp(),Gp.walkTo(Gp.tokenNav)},onCharacter:()=>Qp(),onCharacterDone:()=>$p(),onToggleSound:()=>{let e=!xu().sound;qu(e),Fl(!e),ap(),e&&zl()},onToggleMic:()=>{Ju(!xu().mic),ap()},onMapBack:()=>{Gp.exit(),rp(`title`)},onBannerPlay:()=>im(),onPause:()=>{Wp.pause(),rp(`pause`)},onResume:()=>{rp(null),Wp.resume()},onPauseMap:()=>{Wp.stopRun(),Xp()},onRepeatWord:()=>Wp.repeatWord(),onPlayAgain:()=>rm(Fp.world,Fp.level,Fp.secret),onNextLevel:()=>{let e=am(Fp.world,Fp.level);e&&rm(e.world,e.level)},onCompleteMap:()=>lm(),onBonusSkip:()=>{Rp&&(Rp.advancing=!0,Mp(),Rp.idx=Rp.words.length,pm())},onMicDown:hm,onMicUp:gm,onHouse:e=>em(e),onHouseBack:()=>tm(),onBuyItem:e=>nm(e),onMoveDown:e=>Wp.setMove(`btn`,e,!0),onMoveUp:e=>Wp.setMove(`btn`,e,!1),onJumpDown:()=>Wp.running&&!Wp.paused&&Wp.player.jump(),onJumpUp:()=>{},onDevUnlock:()=>{Gu(gd.length),mu(`All levels unlocked!`,{rate:1}),Gp.refresh()}}),ap(),rp(`title`),Gp.enter(),Gp.exit(),document.addEventListener(`visibilitychange`,()=>{document.hidden&&Wp.running&&!Wp.paused&&(Wp.pause(),rp(`pause`))});