...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(e,t,n){let r=new Float32Array(so),i=new U(0,1,0);return new Hi({name:`SphericalGaussianBlur`,defines:{n:so,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:To(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Hi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:To(),fragmentShader:`
	...
	`}var Eo=class extends At{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Zs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Qs(e,t){let n=Zs[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var $s=new U;function ec(){return G.getLuminanceCoefficients($s),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${$s.x.toFixed(4)}, ${$s.y.toFixed(4)}, ${$s.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Us(i,i.VERTEX_SHADER,y),S=Us(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ys(i,x,`vertex`),n=Ys(i,S,`fragment`);B(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,tl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ai(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Hi({vertexShader:$c,fragmentShader:el,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new q(new Ni(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},nl=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,f=null,p=null,m=null,h=typeof XRWebGLBinding<`u`,_=new tl,v={},y=t.getContextAttributes(),b=null,S=null,C=[],w=[],T=new H,k=null,A=new xa;A.viewport=new Ot;let ee=new xa;ee.viewport=new Ot;let te=[A,ee],j=new Oa,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new un,C[e]=t),t.getHandSpace()};function M(e){let t=w.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=w[e];t!==null&&(w[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(b),p=null,f=null,u=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(T.width,T.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&z(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),y.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;y.depth&&(o=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=y.stencil?O:D,a=y.stencil?x:g);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),f=u.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new At(f.textureWidth,f.textureHeight,{format:E,type:d,depthTexture:new Oi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new At(p.framebufferWidth,p.framebufferHeight,{format:E,type:d,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=w.indexOf(n);r>=0&&(w[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=w.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=w.length){w.push(n),r=e;break}else if(w[e]===null){w[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new U,se=new U;function ce(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=ee.near=A.near=t,j.far=ee.far=A.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,A.layers.mask=j.layers.mask&-5,ee.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;le(j,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(j,A,ee):j.projectionMatrix.copy(A.projectionMatrix),ue(e,j,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let N=null;function de(t,i){if(l=i.getViewerPose(c||a),m=i,l!==null){let t=l.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=u.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=te[n];o===void 0&&(o=new xa,o.layers.enable(n),o.viewport=new Ot,te[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Ai,v[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=w[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}N&&N(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),m=null}let fe=new Ja;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){N=e},this.dispose=function(){}}},rl=new Nt,il=new W;il.set(-1,0,0,0,1,0,0,0,1);function al(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ri(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(rl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(il),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function ol(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return B(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?z(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):z(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var sl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),cl=null;function ll(){return cl===null&&(cl=new ti(sl,16,16,ee,v),cl.name=`DFG_LUT`,cl.minFilter=c,cl.magFilter=c,cl.wrapS=r,cl.wrapT=r,cl.generateMipmaps=!1,cl.needsUpdate=!0),cl}var ul=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:p=!1,outputBufferType:h=d}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);_=n.getContextAttributes().alpha}else _=a;let S=h,C=new Set([j,te,A]),w=new Set([d,g,m,x,y,b]),T=new Uint32Array(4),E=new Int32Array(4),D=new U,O=null,k=null,ee=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null,oe=null,se=null,ce=null;this._outputColorSpace=ze;let le=0,ue=0,N=null,de=-1,fe=null,pe=new Ot,me=new Ot,he=null,ge=new K(0),_e=0,ve=t.width,ye=t.height,be=1,xe=null,Se=null,Ce=new Ot(0,0,ve,ye),we=new Ot(0,0,ve,ye),Te=!1,Ee=new vi,De=!1,Oe=!1,ke=new Nt,Ae=new U,je=new Ot,Me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ne=!1;function Pe(){return N===null?be:1}let P=n;function Fe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:f};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,st,!1),t.addEventListener(`webglcontextrestored`,ct,!1),t.addEventListener(`webglcontextcreationerror`,lt,!1),P===null){let t=`webgl2`;if(P=Fe(t,e),P===null)throw Fe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw B(`WebGLRenderer: `+e.message),e}let F,Ie,I,Le,L,R,Re,Be,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at;function ot(){F=new Oo(P),F.init(),rt=new Qc(P,F),Ie=new ro(P,F,e,rt),I=new Xc(P,F),Ie.reversedDepthBuffer&&p&&I.buffers.depth.setReversed(!0),oe=P.createFramebuffer(),se=P.createFramebuffer(),ce=P.createFramebuffer(),Le=new jo(P),L=new Ac,R=new Zc(P,F,I,L,Ie,rt,Le),Re=new Do(M),Be=new Ya(P),it=new to(P,Be),Ve=new ko(P,Be,Le,it),He=new No(P,Ve,Be,it,Le),$e=new Mo(P,Ie,R),Je=new io(L),Ue=new kc(M,Re,F,Ie,it,Je),We=new al(M,L),Ke=new Pc,qe=new Vc(F),Qe=new eo(M,Re,I,He,_,s),Xe=new Yc(M,He,Ie),at=new ol(P,Le,Ie,I),tt=new no(P,F,Le),nt=new Ao(P,F,Le),Le.programs=Ue.programs,M.capabilities=Ie,M.extensions=F,M.properties=L,M.renderLists=Ke,M.shadowMap=Xe,M.state=I,M.info=Le}ot(),S!==1009&&(re=new Fo(S,t.width,t.height,o,r,i));let V=new nl(M,P);this.xr=V,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=F.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=F.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return be},this.setPixelRatio=function(e){e!==void 0&&(be=e,this.setSize(ve,ye,!1))},this.getSize=function(e){return e.set(ve,ye)},this.setSize=function(e,n,r=!0){if(V.isPresenting){z(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ve=e,ye=n,t.width=Math.floor(e*be),t.height=Math.floor(n*be),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ve*be,ye*be).floor()},this.setDrawingBufferSize=function(e,n,r){ve=e,ye=n,be=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){B(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){z(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(pe)},this.getViewport=function(e){return e.copy(Ce)},this.setViewport=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),I.viewport(pe.copy(Ce).multiplyScalar(be).round())},this.getScissor=function(e){return e.copy(we)},this.setScissor=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),I.scissor(me.copy(we).multiplyScalar(be).round())},this.getScissorTest=function(){return Te},this.setScissorTest=function(e){I.setScissorTest(Te=e)},this.setOpaqueSort=function(e){xe=e},this.setTransparentSort=function(e){Se=e},this.getClearColor=function(e){return e.copy(Qe.getClearColor())},this.setClearColor=function(){Qe.setClearColor(...arguments)},this.getClearAlpha=function(){return Qe.getClearAlpha()},this.setClearAlpha=function(){Qe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Qe.getClearColor(),r=Qe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,st,!1),t.removeEventListener(`webglcontextrestored`,ct,!1),t.removeEventListener(`webglcontextcreationerror`,lt,!1),Qe.dispose(),Ke.dispose(),qe.dispose(),L.dispose(),Re.dispose(),He.dispose(),it.dispose(),at.dispose(),Ue.dispose(),V.dispose(),V.removeEventListener(`sessionstart`,mt),V.removeEventListener(`sessionend`,ht),gt.stop()};function st(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ie=!0}function ct(){Ze(`WebGLRenderer: Context Restored.`),ie=!1;let e=Le.autoReset,t=Xe.enabled,n=Xe.autoUpdate,r=Xe.needsUpdate,i=Xe.type;ot(),Le.autoReset=e,Xe.enabled=t,Xe.autoUpdate=n,Xe.needsUpdate=r,Xe.type=i}function lt(e){B(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ut(e){let t=e.target;t.removeEventListener(`dispose`,ut),H(t)}function H(e){dt(e),L.remove(e)}function dt(e){let t=L.get(e).programs;t!==void 0&&(t.forEach(function(e){Ue.releaseProgram(e)}),e.isShaderMaterial&&Ue.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Me);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Et(e,t,n,r,i);I.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ve.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;it.setup(i,r,s,n,c);let h,g=tt;if(c!==null&&(h=Be.get(c),g=nt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(I.setLineWidth(r.wireframeLinewidth*Pe()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),I.setLineWidth(e*Pe()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh)if(F.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Be.get(c).bytesPerElement:1,o=L.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ft(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,St(e,t,n),e.side=0,e.needsUpdate=!0,St(e,t,n),e.side=2):St(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=qe.get(n),k.init(t),ne.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ft(a,n,e),r.add(a)}else ft(t,n,e),r.add(t)}),k=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){L.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}F.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let pt=null;function W(e){pt&&pt(e)}function mt(){gt.stop()}function ht(){gt.start()}let gt=new Ja;gt.setAnimationLoop(W),typeof self<`u`&&gt.setContext(self),this.setAnimationLoop=function(e){pt=e,V.setAnimationLoop(e),e===null?gt.stop():gt.start()},V.addEventListener(`sessionstart`,mt),V.addEventListener(`sessionend`,ht),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){B(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=V.enabled===!0&&V.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),V.enabled===!0&&V.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(V.cameraAutoUpdate===!0&&V.updateCamera(t),t=V.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),k=qe.get(e,ne.length),k.init(t),k.state.textureUnits=R.getTextureUnits(),ne.push(k),ke.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ee.setFromProjectionMatrix(ke,Ge,t.reversedDepth),Oe=this.localClippingEnabled,De=Je.init(this.clippingPlanes,Oe),O=Ke.get(e,ee.length),O.init(),ee.push(O),V.enabled===!0&&V.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&_t(e,t,-1/0,M.sortObjects)}_t(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(xe,Se,t.reversedDepth),Ne=V.enabled===!1||V.isPresenting===!1||V.hasDepthSensing()===!1,Ne&&Qe.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),De===!0&&Je.beginShadows();let i=k.state.shadowsArray;if(Xe.render(i,e,t),De===!0&&Je.endShadows(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];yt(n,r,e,a)}Ne&&Qe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];vt(O,e,n,n.viewport)}}else r.length>0&&yt(n,r,e,t),Ne&&Qe.render(e),vt(O,e,t)}N!==null&&ue===0&&(R.updateMultisampleRenderTarget(N),R.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),it.resetDefaultState(),de=-1,fe=null,ne.pop(),ne.length>0?(k=ne[ne.length-1],R.setTextureUnits(k.state.textureUnits),De===!0&&Je.setGlobalState(M.clippingPlanes,k.state.camera)):k=null,ee.pop(),O=ee.length>0?ee[ee.length-1]:null,ae!==null&&ae.renderEnd()};function _t(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ee.intersectsSprite(e)){r&&je.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ke);let t=He.update(e),i=e.material;i.visible&&O.push(e,t,i,n,je.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ee.intersectsObject(e))){let t=He.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),je.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),je.copy(e.boundingSphere.center)),je.applyMatrix4(e.matrixWorld).applyMatrix4(ke)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,je.z,o)}}else i.visible&&O.push(e,t,i,n,je.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)_t(i[e],t,n,r)}function vt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),De===!0&&Je.setGlobalState(M.clippingPlanes,n),r&&I.viewport(pe.copy(r)),i.length>0&&bt(i,t,n),a.length>0&&bt(a,t,n),o.length>0&&bt(o,t,n),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function yt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=F.has(`EXT_color_buffer_half_float`)||F.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new At(1,1,{generateMipmaps:!0,type:e?v:d,minFilter:u,samples:Math.max(4,Ie.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:G.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||pe;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),c=M.getActiveCubeFace(),l=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(ge),_e=M.getClearAlpha(),_e<1&&M.setClearColor(16777215,.5),M.clear(),Ne&&Qe.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),De===!0&&Je.setGlobalState(M.clippingPlanes,r),bt(e,n,r),R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a),F.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,xt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(R.updateMultisampleRenderTarget(a),R.updateRenderTargetMipmap(a))}M.setRenderTarget(s,c,l),M.setClearColor(ge,_e),p!==void 0&&(r.viewport=p),M.toneMapping=f}function bt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&xt(o,t,n,s,l,c)}}function xt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function St(e,t,n){t.isScene!==!0&&(t=Me);let r=L.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ue.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ue.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Re.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ut),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return wt(e,s),d}else s.uniforms=Ue.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Ue.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Je.uniform),wt(e,s),r.needsLights=kt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Ct(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Hs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function wt(e,t){let n=L.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Tt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Et(e,t,n,r,i){t.isScene!==!0&&(t=Me),R.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:G.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Re.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=L.get(r),y=k.state.lights;if(De===!0&&(Oe===!0||e!==fe)){let t=e===fe&&r.id===de;Je.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Je.numPlanes||v.numIntersection!==Je.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=St(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(I.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==de&&(de=r.id,C=!0),v.needsLights){let e=Tt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||fe!==e){I.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,Ae.setFromMatrixPosition(e.matrixWorld)),Ie.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),fe!==e&&(fe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,R),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,R),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,R)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,R))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,R),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,R),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,R));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&$e.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=ll()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Dt(E,w),a&&r.fog===!0&&We.refreshFogUniforms(E,a),We.refreshMaterialUniforms(E,r,be,ye,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Hs.upload(P,Ct(v),E,R)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Hs.upload(P,Ct(v),E,R),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];at.update(n,x),at.bind(n,x)}}return x}function Dt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function kt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return le},this.getActiveMipmapLevel=function(){return ue},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=L.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),L.get(e.texture).__webglTexture=t,L.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=L.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){N=e,le=t,ue=n;let r=null,i=!1,a=!1;if(e){let o=L.get(e);if(o.__useDefaultFramebuffer!==void 0){I.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest,I.viewport(pe),I.scissor(me),I.setScissorTest(he),de=-1;return}else if(o.__webglFramebuffer===void 0)R.setupRenderTarget(e);else if(o.__hasExternalTextures)R.rebindTextures(e,L.get(e.texture).__webglTexture,L.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&L.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);R.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=L.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&R.useMultisampledRTT(e)===!1?L.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest}else pe.copy(Ce).multiplyScalar(be).floor(),me.copy(we).multiplyScalar(be).floor(),he=Te;if(n!==0&&(r=oe),I.bindFramebuffer(P.FRAMEBUFFER,r)&&I.drawBuffers(e,r),I.viewport(pe),I.scissor(me),I.setScissorTest(he),i){let r=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=L.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=L.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}de=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){I.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ie.textureFormatReadable(c)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ie.textureTypeReadable(l)){B(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,rt.convert(c),rt.convert(l),a)}finally{let e=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=L.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){I.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Ie.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ie.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,rt.convert(l),rt.convert(u),0);let f=N===null?null:L.get(N).__webglFramebuffer;I.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await et(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;R.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),I.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=rt.convert(t.format),_=rt.convert(t.type),v;t.isData3DTexture?(R.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(R.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(R.setTexture2D(t,0),v=P.TEXTURE_2D),I.activeTexture(P.TEXTURE0),I.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),I.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),I.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=I.getParameter(P.UNPACK_ROW_LENGTH),b=I.getParameter(P.UNPACK_IMAGE_HEIGHT),x=I.getParameter(P.UNPACK_SKIP_PIXELS),S=I.getParameter(P.UNPACK_SKIP_ROWS),C=I.getParameter(P.UNPACK_SKIP_IMAGES);I.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),I.pixelStorei(P.UNPACK_SKIP_PIXELS,l),I.pixelStorei(P.UNPACK_SKIP_ROWS,u),I.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=L.get(e),r=L.get(t),h=L.get(n.__renderTarget),g=L.get(r.__renderTarget);I.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,L.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||L.has(e)){let n=L.get(e),r=L.get(t);I.bindFramebuffer(P.READ_FRAMEBUFFER,se),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,ce);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);I.bindFramebuffer(P.READ_FRAMEBUFFER,null),I.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);I.pixelStorei(P.UNPACK_ROW_LENGTH,y),I.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),I.pixelStorei(P.UNPACK_SKIP_PIXELS,x),I.pixelStorei(P.UNPACK_SKIP_ROWS,S),I.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),I.unbindTexture()},this.initRenderTarget=function(e){L.get(e).__webglFramebuffer===void 0&&R.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?R.setTextureCube(e,0):e.isData3DTexture?R.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?R.setTexture2DArray(e,0):R.setTexture2D(e,0),I.unbindTexture()},this.resetState=function(){le=0,ue=0,N=null,I.reset(),it.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=G._getDrawingBufferColorSpace(e),t.unpackColorSpace=G._getUnpackColorSpace()}},dl=[{top:[9425759,8636500],dirt:[10254152,9399103],plat:[14197082,13407568],hill:7323490,hill2:9426058,sky:8900331,fog:11132403},{top:[15651982,15059326],dirt:[13806935,13082700],plat:[14717530,13928272],hill:14465380,hill2:15389588,sky:9426152,fog:15916734},{top:[16054524,15134455],dirt:[12111584,11190998],plat:[10470632,9615581],hill:13623536,hill2:15266554,sky:11061480,fog:14412279},{top:[8747176,8022934],dirt:[6184556,5526623],plat:[10448852,9593799],hill:4536926,hill2:5786229,sky:2366771,fog:3352906},{top:[10215546,9361518],dirt:[10254152,9399103],plat:[16766282,16107838],hill:8703333,hill2:12445951,sky:7324671,fog:12182271}];function fl(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function pl({seed:e,wordCount:t,theme:n,secret:r=!1,hasKey:i=!1}){let a=fl(e),o=[],s=[],c=[],l=[],u=[],d=0,f=null,p=()=>o.length,m=e=>{for(let t=0;t<e;t++)o.push(d)},h=(e,t,n,r=1.4)=>{for(let i=0;i<n;i++)c.push({x:e+i*r,y:t})},g=(e,t,n)=>{for(let r=0;r<5;r++){let i=r/4;c.push({x:e+i*t,y:n+Math.sin(i*Math.PI)*1.2})}};m(8),h(4,d+.8,3);let _=i?t>>1:-1,v=r?t>>1:-1,y=e%2;for(let e=0;e<t;e++){let t=14+(a()*5|0)+(r?4:0),n=p(),i=0;for(;i<t;){let e=Math.min(t-i,5+(a()*6|0));if(m(e),i+=e,i<t){let e=[1,1,2,-1,-2,0][a()*6|0];d=Math.max(0,Math.min(4,d+e))}a()<(r?.6:.35)&&h(p()-e+1,d+.8,Math.min(4,e-1))}if(a()<(r?.95:.75)&&t>11){let e=3+(a()*2|0),r=n+3+(a()*(t-e-6)|0),i=o[Math.min(r,p()-1)]+(a()<.35?2:3);s.push({x0:r,x1:r+e-1,y:i}),g(r-.5,e,i+1.1)}if(l.length<6&&a()<.55&&t>10){let e=p()-7;l.push({x0:e,x1:e+4})}if(e===_){let e=p()+3;m(8),s.push({x0:e,x1:e+1,y:d+3}),f={x:e+.5,y:d+4.2}}if(e===v){let e=p();m(16),s.push({x0:e+3,x1:e+6,y:d+3}),s.push({x0:e+9,x1:e+12,y:d+3});for(let t=e+2;t<=e+13;t+=1.5)c.push({x:t,y:d+1}),c.push({x:t,y:d+2}),c.push({x:t,y:d+4.2})}let b=(e+y)%2==0?`blocks`:`doors`;if(b===`blocks`)u.push({type:b,x:p(),groundY:d}),m(36);else{let e=p();u.push({type:b,x:e,wallX:e+12,groundY:d}),s.push({x0:e+6,x1:e+11,y:d+2}),s.push({x0:e+9,x1:e+11,y:d+4}),m(19)}}let b=p()+5;m(28);let x=p()+5;m(12);let S=u.filter(e=>e.type===`doors`).map(e=>({a:e.x-6,b:e.wallX+6})),C=e=>S.every(t=>e.x1<t.a||e.x0>t.b),w=[];for(let e of l){let t=e;for(let e of S)if(!(t.x1<e.a||t.x0>e.b)){let n=t.x1-t.x0;t={x0:e.a-1-n,x1:e.a-1}}t.x0>12&&C(t)&&w.every(e=>t.x1<e.x0-2||t.x0>e.x1+2)&&w.push(t)}return{groundY:o,platforms:s,coins:c,critters:w,events:u,key:f,starX:b,flagX:x,length:p(),theme:n,secret:r}}function ml({seed:e,wordCount:t,theme:n}){let r=fl(e),i=[],a=[],o=[],s=0,c=()=>i.length,l=e=>{for(let t=0;t<e;t++)i.push(s)};l(14);for(let e=0;e<t;e++){e>0&&(s=Math.max(0,Math.min(2,s+[0,1,-1][r()*3|0])));let t=5+(r()*3|0);if(l(t),r()<.7)for(let e=0;e<4;e++)a.push({x:c()-t+1+e*1.3,y:s+.8});o.push({type:`blocks`,x:c(),groundY:s}),l(36)}let u=c()+4;l(8);let d=c()+5;return l(12),{groundY:i,platforms:[],coins:a,critters:[],events:o,key:null,starX:u,flagX:d,length:c(),theme:n,secret:!1,boss:!0}}var hl=2e4,gl=260,_l=6,vl=new ji(1,1,1),yl=[(e,t,n)=>{e(t,n+.7,-3.5,.4,1.4,.4,8015658),e(t,n+1.9,-3.5,1.7,1.4,1.7,4169274),e(t,n+2.8,-3.5,1.1,.8,1.1,5027141)},(e,t,n,r)=>{e(t,n+1,-3.5,.5,2,.5,5088076),e(t+.55,n+1.3,-3.5,.9,.35,.35,5088076),e(t+.85,n+1.7,-3.5,.35,.7,.35,5088076),r()<.5&&e(t+2,n+.25,-4,.9,.5,.9,14717530)},(e,t,n)=>{e(t,n+.5,-3.5,1,1,1,16777215),e(t,n+1.35,-3.5,.75,.75,.75,16054524),e(t,n+1.98,-3.5,.55,.55,.55,16777215),e(t+1.8,n+.5,-4.2,.3,1,.3,8015658),e(t+1.8,n+1.5,-4.2,1.2,1.1,1.2,14675708)},(e,t,n,r)=>{let i=[8319231,13663999,16747224];for(let a=0;a<3;a++){let o=i[r()*i.length|0];e(t+(a-1)*.7,n+.8+r()*.6,-3.5,.4,1.4+r()*1.2,.4,o,o)}e(t,n+.15,-3.5,1.6,.5,1.6,5526623)},(e,t,n,r)=>{let i=n+2.2+r()*1.5;e(t,i,-4,1.4,.5,1.4,9361518),e(t,i-.5,-4,1,.6,1,10254152),e(t,i+.55,-4,.7,.6,.7,4169274)}],bl=class{constructor(e){this.scene=e,this.data=null,this.blocks=new ui(vl,new J,hl),this.blocks.frustumCulled=!1,this.blocks.count=0,e.add(this.blocks),this.coinMesh=new ui(new ji(.55,.55,.12),new J({color:16766282,emissive:6704384}),gl),this.coinMesh.frustumCulled=!1,this.coinMesh.count=0,e.add(this.coinMesh),this.coinStates=[],this.coinSpin=0,this.dummy=new sn,this.color=new K,this.flagGroup=new cn;let t=new q(vl,new J({color:14277081}));t.scale.set(.18,8,.18),t.position.y=4;let n=new q(vl,new J({color:16766282,emissive:6704384}));n.scale.setScalar(.5),n.position.y=8.2;let r=new q(vl,new J({color:9263659}));r.scale.set(1.4,.6,1.4),r.position.y=.3,this.flag=new q(vl,new J({color:5036388})),this.flag.scale.set(1.4,.9,.1),this.flag.position.set(-.85,7.4,0),this.flagGroup.add(t,n,r,this.flag),e.add(this.flagGroup),this.parallax=[];let i=(t,n,r,i)=>{let a=new J,o=new ui(vl,a,16);o.frustumCulled=!1;let s=fl(r),c=new sn,l=[];for(let e=0;e<4;e++)l.push({x:e*22+s()*8,w:9+s()*8,h:i+s()*3});let u=0;for(let e=0;e<2;e++)for(let t of l)c.position.set(e*90+t.x,t.h/2-2,0),c.scale.set(t.w,t.h+4,2.5),c.updateMatrix(),o.setMatrixAt(u++,c.matrix),c.position.set(e*90+t.x,t.h+.8,0),c.scale.set(t.w*.55,1.6,2.2),c.updateMatrix(),o.setMatrixAt(u++,c.matrix);o.count=u,o.instanceMatrix.needsUpdate=!0,o.position.z=t,e.add(o),this.parallax.push({mesh:o,mat:a,factor:n})};i(-14,.3,51,2),i(-20,.15,87,4.5),this.clouds=[];let a=new J({color:16777215});for(let t=0;t<_l;t++){let t=new cn;for(let e=0;e<3;e++){let n=new q(vl,a);n.scale.set(1.6+Math.random()*2,.8,1.4+Math.random()),n.position.set(e*1.4-1.4,Math.random()*.4,(Math.random()-.5)*1.5),t.add(n)}t.userData.drift=.3+Math.random()*.5,e.add(t),this.clouds.push(t)}}build(e){this.data=e;let t=dl[e.theme];this.scene.background=new K(t.sky),this.scene.fog=new gn(t.fog,30,80),this.parallax[0].mat.color.setHex(t.hill).multiplyScalar(.72),this.parallax[1].mat.color.setHex(t.hill2).lerp(new K(t.sky),.35);let n=fl((e.theme+1)*7919),r=0,i=(e,t,n,i,a,o,s,c=0)=>{r>=hl||(this.dummy.position.set(e,t,n),this.dummy.scale.set(i,a,o),this.dummy.rotation.set(0,0,0),this.dummy.updateMatrix(),this.blocks.setMatrixAt(r,this.dummy.matrix),this.color.setHex(s),c&&this.color.offsetHSL(0,.1,.08),this.blocks.setColorAt(r,this.color),r++)},a=e.length;for(let n=0;n<a;n++){let r=e.groundY[n];for(let e=-1;e<=1;e++)for(let a=0;a<4;a++){let o=(a===0?t.top:t.dirt)[n+e+a&1];i(n,r-.5-a,e,1,1,1,o)}for(let e=-5;e<=-2;e++)i(n,r-.5,e,1,1.001,1,t.dirt[n+e&1])}for(let n of e.platforms)for(let e=n.x0;e<=n.x1;e++)for(let r=0;r<=1;r++)i(e,n.y-.5,r-.5,1,1,1,t.plat[e+r&1]);for(let e=-10;e<a+20;e+=24+(n()*14|0)){let r=1.5+n()*2,a=9+n()*7;i(e,r/2-1.5,-12,a,r+3,4,t.hill),i(e,r+1.5+n(),-12,a*.55,2,3.4,t.hill);let o=3+n()*3,s=e+10+n()*8;i(s,o/2-1.5,-19,a*1.5,o+3,4,t.hill2),i(s,o+1.5+n(),-19,a*.8,2.4,3.4,t.hill2)}let o=yl[e.theme];for(let t=4;t<a-4;t+=10+(n()*9|0)){let r=e.groundY[Math.min(t,a-1)];o(i,t+n()*3,r,n)}this.blocks.count=r,this.blocks.instanceMatrix.needsUpdate=!0,this.blocks.instanceColor&&(this.blocks.instanceColor.needsUpdate=!0),this.coinStates=e.coins.slice(0,gl).map(e=>({x:e.x,y:e.y,taken:!1})),this.coinMesh.count=this.coinStates.length,this.updateCoinMatrices();let s=e.groundY[Math.min(e.flagX|0,a-1)];this.flagGroup.position.set(e.flagX,s,0),this.flag.position.y=7.4;for(let e of this.clouds)e.position.set(Math.random()*60-10,8+Math.random()*4,-7-Math.random()*5)}updateCoinMatrices(){for(let e=0;e<this.coinStates.length;e++){let t=this.coinStates[e];this.dummy.position.set(t.x,t.taken?-50:t.y+Math.sin(this.coinSpin*2+t.x)*.1,0),this.dummy.rotation.set(0,this.coinSpin+t.x*.5,0),this.dummy.scale.setScalar(t.taken?.001:1),this.dummy.updateMatrix(),this.coinMesh.setMatrixAt(e,this.dummy.matrix)}this.coinMesh.instanceMatrix.needsUpdate=!0}collectCoins(e,t){let n=[];for(let r of this.coinStates)r.taken||Math.abs(r.x-e)>.9||r.y>t-.4&&r.y<t+2.1&&(r.taken=!0,n.push(new U(r.x,r.y,0)));return n}update(e,t){this.coinSpin+=e*3,this.updateCoinMatrices();for(let e of this.parallax){let n=t*(1-e.factor);e.mesh.position.x=t*e.factor+Math.floor((n-45)/90)*90}for(let n of this.clouds)n.position.x+=n.userData.drift*e,n.position.x<t-45&&(n.position.x+=90),n.position.x>t+45&&(n.position.x-=90)}groundTopAt(e){if(!this.data)return 0;let t=Math.max(0,Math.min(this.data.length-1,Math.round(e)));return this.data.groundY[t]}floorAt(e,t){let n=-1/0;for(let r of[-.25,.25]){let i=this.groundTopAt(e+r);i<=t+.3&&i>n&&(n=i)}if(this.data)for(let r of this.data.platforms)e>=r.x0-.8&&e<=r.x1+.8&&r.y<=t+.3&&r.y>n&&(n=r.y);return n===-1/0&&(n=this.groundTopAt(e)),n}},xl={words:{a:`w-a.mp3`,and:`w-and.mp3`,away:`w-away.mp3`,big:`w-big.mp3`,blue:`w-blue.mp3`,can:`w-can.mp3`,come:`w-come.mp3`,down:`w-down.mp3`,find:`w-find.mp3`,for:`w-for.mp3`,funny:`w-funny.mp3`,go:`w-go.mp3`,help:`w-help.mp3`,here:`w-here.mp3`,i:`w-i.mp3`,in:`w-in.mp3`,is:`w-is.mp3`,it:`w-it.mp3`,jump:`w-jump.mp3`,little:`w-little.mp3`,look:`w-look.mp3`,make:`w-make.mp3`,me:`w-me.mp3`,my:`w-my.mp3`,not:`w-not.mp3`,one:`w-one.mp3`,play:`w-play.mp3`,red:`w-red.mp3`,run:`w-run.mp3`,said:`w-said.mp3`,see:`w-see.mp3`,the:`w-the.mp3`,three:`w-three.mp3`,to:`w-to.mp3`,two:`w-two.mp3`,up:`w-up.mp3`,we:`w-we.mp3`,where:`w-where.mp3`,yellow:`w-yellow.mp3`,you:`w-you.mp3`,all:`w-all.mp3`,am:`w-am.mp3`,are:`w-are.mp3`,at:`w-at.mp3`,ate:`w-ate.mp3`,be:`w-be.mp3`,black:`w-black.mp3`,brown:`w-brown.mp3`,but:`w-but.mp3`,came:`w-came.mp3`,did:`w-did.mp3`,do:`w-do.mp3`,eat:`w-eat.mp3`,four:`w-four.mp3`,get:`w-get.mp3`,good:`w-good.mp3`,have:`w-have.mp3`,he:`w-he.mp3`,into:`w-into.mp3`,like:`w-like.mp3`,must:`w-must.mp3`,new:`w-new.mp3`,no:`w-no.mp3`,now:`w-now.mp3`,on:`w-on.mp3`,our:`w-our.mp3`,out:`w-out.mp3`,please:`w-please.mp3`,pretty:`w-pretty.mp3`,ran:`w-ran.mp3`,ride:`w-ride.mp3`,saw:`w-saw.mp3`,say:`w-say.mp3`,she:`w-she.mp3`,so:`w-so.mp3`,soon:`w-soon.mp3`,that:`w-that.mp3`,there:`w-there.mp3`,they:`w-they.mp3`,this:`w-this.mp3`,too:`w-too.mp3`,under:`w-under.mp3`,want:`w-want.mp3`,was:`w-was.mp3`,well:`w-well.mp3`,went:`w-went.mp3`,what:`w-what.mp3`,white:`w-white.mp3`,who:`w-who.mp3`,will:`w-will.mp3`,with:`w-with.mp3`,yes:`w-yes.mp3`,after:`w-after.mp3`,again:`w-again.mp3`,an:`w-an.mp3`,any:`w-any.mp3`,as:`w-as.mp3`,ask:`w-ask.mp3`,by:`w-by.mp3`,could:`w-could.mp3`,every:`w-every.mp3`,fly:`w-fly.mp3`,from:`w-from.mp3`,give:`w-give.mp3`,going:`w-going.mp3`,had:`w-had.mp3`,has:`w-has.mp3`,her:`w-her.mp3`,him:`w-him.mp3`,his:`w-his.mp3`,how:`w-how.mp3`,just:`w-just.mp3`,know:`w-know.mp3`,let:`w-let.mp3`,live:`w-live.mp3`,may:`w-may.mp3`,of:`w-of.mp3`,old:`w-old.mp3`,once:`w-once.mp3`,open:`w-open.mp3`,over:`w-over.mp3`,put:`w-put.mp3`,round:`w-round.mp3`,some:`w-some.mp3`,stop:`w-stop.mp3`,take:`w-take.mp3`,thank:`w-thank.mp3`,them:`w-them.mp3`,then:`w-then.mp3`,think:`w-think.mp3`,walk:`w-walk.mp3`,were:`w-were.mp3`,when:`w-when.mp3`,always:`w-always.mp3`,around:`w-around.mp3`,because:`w-because.mp3`,been:`w-been.mp3`,before:`w-before.mp3`,best:`w-best.mp3`,both:`w-both.mp3`,buy:`w-buy.mp3`,call:`w-call.mp3`,cold:`w-cold.mp3`,does:`w-does.mp3`,"don't":`w-dont.mp3`,fast:`w-fast.mp3`,first:`w-first.mp3`,five:`w-five.mp3`,found:`w-found.mp3`,gave:`w-gave.mp3`,goes:`w-goes.mp3`,green:`w-green.mp3`,its:`w-its.mp3`,made:`w-made.mp3`,many:`w-many.mp3`,off:`w-off.mp3`,or:`w-or.mp3`,pull:`w-pull.mp3`,read:`w-read.mp3`,right:`w-right.mp3`,sing:`w-sing.mp3`,sit:`w-sit.mp3`,sleep:`w-sleep.mp3`,tell:`w-tell.mp3`,their:`w-their.mp3`,these:`w-these.mp3`,those:`w-those.mp3`,upon:`w-upon.mp3`,us:`w-us.mp3`,use:`w-use.mp3`,very:`w-very.mp3`,wash:`w-wash.mp3`,which:`w-which.mp3`,why:`w-why.mp3`,wish:`w-wish.mp3`,work:`w-work.mp3`,would:`w-would.mp3`,write:`w-write.mp3`,your:`w-your.mp3`,about:`w-about.mp3`,better:`w-better.mp3`,bring:`w-bring.mp3`,carry:`w-carry.mp3`,clean:`w-clean.mp3`,cut:`w-cut.mp3`,done:`w-done.mp3`,draw:`w-draw.mp3`,drink:`w-drink.mp3`,eight:`w-eight.mp3`,fall:`w-fall.mp3`,far:`w-far.mp3`,full:`w-full.mp3`,got:`w-got.mp3`,grow:`w-grow.mp3`,hold:`w-hold.mp3`,hot:`w-hot.mp3`,hurt:`w-hurt.mp3`,if:`w-if.mp3`,keep:`w-keep.mp3`,kind:`w-kind.mp3`,laugh:`w-laugh.mp3`,light:`w-light.mp3`,long:`w-long.mp3`,much:`w-much.mp3`,myself:`w-myself.mp3`,never:`w-never.mp3`,only:`w-only.mp3`,own:`w-own.mp3`,pick:`w-pick.mp3`,seven:`w-seven.mp3`,shall:`w-shall.mp3`,show:`w-show.mp3`,six:`w-six.mp3`,small:`w-small.mp3`,start:`w-start.mp3`,ten:`w-ten.mp3`,today:`w-today.mp3`,together:`w-together.mp3`,try:`w-try.mp3`,warm:`w-warm.mp3`},phrases:{"find the word:":`p-find-the-word.mp3`,"bonk the block with the word:":`p-bonk-the-block-with-the-word.mp3`,"jump through the door with the word:":`p-jump-through-the-door-with-the-word.mp3`,"star time! grab the star with the word:":`p-star-time-grab-the-star-with-the-word.mp3`,"almost! the word is:":`p-almost-the-word-is.mp3`,"nice try! the word is:":`p-nice-try-the-word-is.mp3`,"try again!":`p-try-again.mp3`,"great job!":`p-great-job.mp3`,"you got it!":`p-you-got-it.mp3`,"awesome!":`p-awesome.mp3`,"super reading!":`p-super-reading.mp3`,"you found a secret key!":`p-you-found-a-secret-key.mp3`,"level complete! amazing!":`p-level-complete-amazing.mp3`,"bonus round! read the word out loud. hold the microphone and say it!":`p-bonus-round-read-the-word-out-loud-hold-the-microphone-and-say-it.mp3`,"all levels unlocked!":`p-all-levels-unlocked.mp3`,"a secret path appeared!":`p-a-secret-path-appeared.mp3`,"the grass golem wants to hear you read!":`p-the-grass-golem-wants-to-hear-you-read.mp3`,"you did it! the grass golem is amazed by your reading! here comes your crown!":`p-you-did-it-the-grass-golem-is-amazed-by-your-reading-here-comes-your-crown.mp3`,"the sand serpent wants to hear you read!":`p-the-sand-serpent-wants-to-hear-you-read.mp3`,"you did it! the sand serpent is amazed by your reading! here comes your crown!":`p-you-did-it-the-sand-serpent-is-amazed-by-your-reading-here-comes-your-crown.mp3`,"the frost yeti wants to hear you read!":`p-the-frost-yeti-wants-to-hear-you-read.mp3`,"you did it! the frost yeti is amazed by your reading! here comes your crown!":`p-you-did-it-the-frost-yeti-is-amazed-by-your-reading-here-comes-your-crown.mp3`,"the crystal golem wants to hear you read!":`p-the-crystal-golem-wants-to-hear-you-read.mp3`,"you did it! the crystal golem is amazed by your reading! here comes your crown!":`p-you-did-it-the-crystal-golem-is-amazed-by-your-reading-here-comes-your-crown.mp3`,"the cloud dragon wants to hear you read!":`p-the-cloud-dragon-wants-to-hear-you-read.mp3`,"you did it! the cloud dragon is amazed by your reading! here comes your crown!":`p-you-did-it-the-cloud-dragon-is-amazed-by-your-reading-here-comes-your-crown.mp3`,"grass plains 1":`p-grass-plains-1.mp3`,"grass plains 2":`p-grass-plains-2.mp3`,"grass plains 3":`p-grass-plains-3.mp3`,"grass plains 4":`p-grass-plains-4.mp3`,"grass plains 5":`p-grass-plains-5.mp3`,"grass plains 6":`p-grass-plains-6.mp3`,"grass plains 7":`p-grass-plains-7.mp3`,"grass plains 8":`p-grass-plains-8.mp3`,"grass plains secret":`p-grass-plains-secret.mp3`,"grass plains castle":`p-grass-plains-castle.mp3`,"sandy desert 1":`p-sandy-desert-1.mp3`,"sandy desert 2":`p-sandy-desert-2.mp3`,"sandy desert 3":`p-sandy-desert-3.mp3`,"sandy desert 4":`p-sandy-desert-4.mp3`,"sandy desert 5":`p-sandy-desert-5.mp3`,"sandy desert 6":`p-sandy-desert-6.mp3`,"sandy desert 7":`p-sandy-desert-7.mp3`,"sandy desert 8":`p-sandy-desert-8.mp3`,"sandy desert 9":`p-sandy-desert-9.mp3`,"sandy desert 10":`p-sandy-desert-10.mp3`,"sandy desert secret":`p-sandy-desert-secret.mp3`,"sandy desert castle":`p-sandy-desert-castle.mp3`,"snowy peaks 1":`p-snowy-peaks-1.mp3`,"snowy peaks 2":`p-snowy-peaks-2.mp3`,"snowy peaks 3":`p-snowy-peaks-3.mp3`,"snowy peaks 4":`p-snowy-peaks-4.mp3`,"snowy peaks 5":`p-snowy-peaks-5.mp3`,"snowy peaks 6":`p-snowy-peaks-6.mp3`,"snowy peaks 7":`p-snowy-peaks-7.mp3`,"snowy peaks 8":`p-snowy-peaks-8.mp3`,"snowy peaks secret":`p-snowy-peaks-secret.mp3`,"snowy peaks castle":`p-snowy-peaks-castle.mp3`,"crystal caves 1":`p-crystal-caves-1.mp3`,"crystal caves 2":`p-crystal-caves-2.mp3`,"crystal caves 3":`p-crystal-caves-3.mp3`,"crystal caves 4":`p-crystal-caves-4.mp3`,"crystal caves 5":`p-crystal-caves-5.mp3`,"crystal caves 6":`p-crystal-caves-6.mp3`,"crystal caves 7":`p-crystal-caves-7.mp3`,"crystal caves 8":`p-crystal-caves-8.mp3`,"crystal caves 9":`p-crystal-caves-9.mp3`,"crystal caves secret":`p-crystal-caves-secret.mp3`,"crystal caves castle":`p-crystal-caves-castle.mp3`,"sky islands 1":`p-sky-islands-1.mp3`,"sky islands 2":`p-sky-islands-2.mp3`,"sky islands 3":`p-sky-islands-3.mp3`,"sky islands 4":`p-sky-islands-4.mp3`,"sky islands 5":`p-sky-islands-5.mp3`,"sky islands 6":`p-sky-islands-6.mp3`,"sky islands 7":`p-sky-islands-7.mp3`,"sky islands 8":`p-sky-islands-8.mp3`,"sky islands secret":`p-sky-islands-secret.mp3`,"sky islands castle":`p-sky-islands-castle.mp3`,"play!":`p-play.mp3`,settings:`p-settings.mp3`,close:`p-close.mp3`,sound:`p-sound.mp3`,"mic round":`p-mic-round.mp3`,back:`p-back.mp3`,"here we go!":`p-here-we-go.mp3`,pause:`p-pause.mp3`,resume:`p-resume.mp3`,map:`p-map.mp3`,"play again!":`p-play-again.mp3`,"next level!":`p-next-level.mp3`,skip:`p-skip.mp3`}},Sl=null,Cl=null,wl=!1,Tl=!1,El=null;function Dl(){if(!Sl){let e=window.AudioContext||window.webkitAudioContext;if(!e)return null;Sl=new e,Cl=Sl.createGain(),Cl.gain.value=.5,Cl.connect(Sl.destination)}return Sl}function Ol(){if(Tl)return;Tl=!0;let e=Dl();e&&e.state===`suspended`&&e.resume();try{if(`speechSynthesis`in window){let e=new SpeechSynthesisUtterance(` `);e.volume=0,speechSynthesis.speak(e)}}catch{}}function kl(e){wl=e,Cl&&(Cl.gain.value=e?0:.5),e&&iu()}function Al({type:e=`sine`,from:t=440,to:n=null,dur:r=.15,at:i=0,vol:a=.5}){let o=Dl();if(!o||wl)return;let s=o.currentTime+i,c=o.createOscillator(),l=o.createGain();c.type=e,c.frequency.setValueAtTime(t,s),n!==null&&c.frequency.exponentialRampToValueAtTime(Math.max(1,n),s+r),l.gain.setValueAtTime(a,s),l.gain.exponentialRampToValueAtTime(.001,s+r),c.connect(l).connect(Cl),c.start(s),c.stop(s+r+.02)}var jl=null;function Ml(e){if(!jl){jl=e.createBuffer(1,e.sampleRate*.5,e.sampleRate);let t=jl.getChannelData(0);for(let e=0;e<t.length;e++)t[e]=Math.random()*2-1}return jl}function Nl(){Al({type:`square`,from:988,dur:.07,vol:.25}),Al({type:`square`,from:1319,dur:.18,at:.07,vol:.25})}function Pl(){[523.25,659.25,783.99,1046.5].forEach((e,t)=>{Al({type:`triangle`,from:e,dur:.22,at:t*.09,vol:.4}),Al({type:`sine`,from:e*2,dur:.18,at:t*.09,vol:.12})})}function Fl(){Al({type:`sine`,from:220,to:110,dur:.3,vol:.4})}function Il(){let e=Dl();if(!e||wl)return;let t=e.currentTime,n=e.createBufferSource();n.buffer=Ml(e);let r=e.createBiquadFilter();r.type=`bandpass`,r.Q.value=4,r.frequency.setValueAtTime(400,t),r.frequency.exponentialRampToValueAtTime(2400,t+.25);let i=e.createGain();i.gain.setValueAtTime(.3,t),i.gain.exponentialRampToValueAtTime(.001,t+.28),n.connect(r).connect(i).connect(Cl),n.start(t),n.stop(t+.3)}function Ll(){Al({type:`square`,from:200+Math.random()*500,to:60,dur:.12,vol:.3})}function Rl(){for(let e=0;e<6;e++)setTimeout(Ll,e*180+Math.random()*100)}function zl(e=0){let t=587*2**(e%16/12);Al({type:`triangle`,from:t,dur:.12,vol:.25}),Al({type:`sine`,from:t*2,dur:.09,vol:.08})}function Bl(){Al({type:`square`,from:150,to:70,dur:.14,vol:.35})}function Vl(){Al({type:`square`,from:320,to:60,dur:.16,vol:.35}),Al({type:`sine`,from:90,dur:.1,at:.02,vol:.3})}function Hl(){Al({type:`sine`,from:180,to:720,dur:.28,vol:.35}),Al({type:`sine`,from:195,to:750,dur:.28,at:.03,vol:.18})}function Ul(){Al({type:`sawtooth`,from:110,to:330,dur:.35,vol:.16}),Al({type:`triangle`,from:523,dur:.18,at:.28,vol:.3}),Al({type:`triangle`,from:784,dur:.24,at:.38,vol:.3})}function Wl(){[1047,1319,1568,2093,1568,2093].forEach((e,t)=>{Al({type:`triangle`,from:e,dur:.14,at:t*.08,vol:.3})})}function Gl(){Al({type:`sawtooth`,from:300,to:90,dur:.7,vol:.3}),Al({type:`square`,from:150,to:60,dur:.5,at:.15,vol:.18}),Al({type:`sawtooth`,from:500,to:200,dur:.4,at:.05,vol:.12})}function Kl(){[880,1100,880,1320].forEach((e,t)=>{Al({type:`triangle`,from:e,to:e*1.2,dur:.09,at:t*.09,vol:.22})})}function ql(){Al({type:`square`,from:180,to:60,dur:.12,vol:.35}),Al({type:`triangle`,from:784,dur:.15,at:.08,vol:.3}),Al({type:`triangle`,from:1047,dur:.2,at:.16,vol:.3})}function Jl(){Al({type:`sine`,from:600,to:1800,dur:.3,vol:.35}),Al({type:`triangle`,from:1200,dur:.2,at:.14,vol:.25})}var Yl=.12,Xl=new Map,Zl=0,Ql=[],$l=null,eu=e=>e.trim().toLowerCase().replace(/\s+/g,` `);function tu(e){let t=eu(e);if(xl.phrases[t])return[xl.phrases[t]];let n=t.indexOf(`: `);if(n===-1)return xl.words[t]?[xl.words[t]]:null;let r=xl.phrases[t.slice(0,n+1)];if(!r)return null;let i=t.slice(n+2),a=null;i.endsWith(` try again!`)&&(a=xl.phrases[`try again!`],i=i.slice(0,-11));let o=xl.words[i.replace(/[.!?]+$/,``).trim()];return o?a?[r,o,a]:[r,o]:null}function nu(e){let t=e.getChannelData(0),n=.004,r=0,i=t.length-1;for(;r<i&&Math.abs(t[r])<n;)r++;for(;i>r&&Math.abs(t[i])<n;)i--;let a=Math.round(e.sampleRate*.04);return r=Math.max(0,r-a),i=Math.min(t.length-1,i+a),{buf:e,offset:r/e.sampleRate,dur:(i-r)/e.sampleRate}}function ru(e){if(!Xl.has(e)){let t=fetch(`tts/${e}`).then(e=>{if(!e.ok)throw Error(`tts fetch ${e.status}`);return e.arrayBuffer()}).then(e=>Sl.decodeAudioData(e)).then(nu);t.catch(()=>Xl.delete(e)),Xl.set(e,t)}return Xl.get(e)}function iu(){Zl++;for(let e of Ql)try{e.onended=null,e.stop()}catch{}Ql=[],`speechSynthesis`in window&&speechSynthesis.cancel(),$l&&$l()}function au(e,t,n){if(!(`speechSynthesis`in window)){setTimeout(n,100);return}try{let r=new SpeechSynthesisUtterance(e);El&&(r.voice=El),r.lang=`en-US`,r.rate=t,r.pitch=1.05,r.onend=n,r.onerror=n,setTimeout(n,1e3+e.length*130),speechSynthesis.speak(r)}catch{n()}}function ou(){if(!(`speechSynthesis`in window))return;let e=speechSynthesis.getVoices();e.length&&(El=e.find(e=>e.lang===`en-US`&&/samantha|alex|google us/i.test(e.name))||e.find(e=>e.lang===`en-US`)||e.find(e=>e.lang&&e.lang.startsWith(`en`))||null)}typeof window<`u`&&`speechSynthesis`in window&&(ou(),speechSynthesis.addEventListener(`voiceschanged`,ou));function su(e,{rate:t=1,onend:n=null}={}){if(iu(),wl){n&&setTimeout(n,100);return}let r=!1,i=()=>{r||(r=!0,$l===i&&($l=null),n&&n())};$l=i;let a=tu(e),o=a&&Dl();if(!o){au(e,t,i);return}let s=Zl;Promise.all(a.map(ru)).then(e=>{if(s!==Zl)return;let t=o.currentTime+.03;Ql=e.map(({buf:e,offset:n,dur:r})=>{let i=o.createBufferSource();return i.buffer=e,i.connect(Cl),i.start(t,n,r),t+=r+Yl,i}),Ql[Ql.length-1].onended=i,setTimeout(i,(t-o.currentTime)*1e3+500)},()=>{s===Zl&&au(e,t,i)})}var cu=1.7,lu=-24,uu=-15,du=10.2,fu=.12,pu=.15;function mu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ffcf9e`,t.fillRect(0,0,64,64),t.fillStyle=`#5a3d1e`,t.fillRect(0,0,64,14),t.fillStyle=`#222`,t.fillRect(16,26,8,8),t.fillRect(40,26,8,8),t.strokeStyle=`#a34d2a`,t.lineWidth=4,t.beginPath(),t.arc(32,42,10,.2*Math.PI,.8*Math.PI),t.stroke();let n=new Di(e);return n.magFilter=a,n.colorSpace=ze,n}function hu(e=1){let t=new cn,n=new ji(1,1,1),r=new J({color:16764830}),i=new J({color:5913886}),a=new J({color:2718207}),o=new J({color:3622735}),s=new q(n,[r,i,i,r,new J({map:mu()}),i]);s.rotation.y=Math.PI/2,s.scale.set(.5,.5,.5),s.position.y=1.35;let c=new q(n,a);c.scale.set(.5,.6,.3),c.position.y=.8;let l=(e,t,r)=>{let i=new cn,a=new q(n,e);return a.scale.set(t,r,t),a.position.y=-r/2,i.add(a),i},u=l(a,.16,.5);u.position.set(0,1.08,-.34);let d=l(a,.16,.5);d.position.set(0,1.08,.34);let f=l(o,.18,.5);f.position.set(0,.5,-.14);let p=l(o,.18,.5);return p.position.set(0,.5,.14),t.add(s,c,u,d,f,p),t.scale.setScalar(e),t.userData.parts={head:s,body:c,armL:u,armR:d,legL:f,legR:p,mats:[r,i,a,o]},t}var gu=class{constructor(e){this.group=hu(1),e.add(this.group),this.parts=this.group.userData.parts;let t=new Mi(.5,16);t.rotateX(-Math.PI/2),this.shadow=new q(t,new Vr({color:0,transparent:!0,opacity:.3,depthWrite:!1})),e.add(this.shadow),this.reset(0,0)}reset(e,t){this.x=e,this.y=t,this.vy=0,this.grounded=!0,this.buffer=0,this.coyote=0,this.fallPeak=t,this.stumbleT=0,this.squashT=0,this.walkPhase=0,this.faceYaw=-Math.PI/2,this.group.position.set(e,t,0),this.group.rotation.set(0,this.faceYaw,0),this.group.scale.setScalar(1);for(let e of this.parts.mats)e.emissive.setHex(0)}jump(){this.buffer=pu}bounce(e){this.vy=e,this.grounded=!1,this.fallPeak=this.y}stumble(){this.stumbleT=.6;for(let e of this.parts.mats)e.emissive.setHex(11149858)}get isAirborne(){return!this.grounded}update(e,t,n,r){if(t!==0){let r=t>0?1:-1,i=this.x+t*e;n.groundTopAt(i+.7/2*r)<=this.y+.25&&(this.x=i)}if(this.buffer-=e,this.coyote-=e,this.grounded&&(this.coyote=fu),this.buffer>0&&(this.grounded||this.coyote>0)&&(this.vy=du,this.grounded=!1,this.buffer=0,this.coyote=0,this.fallPeak=this.y,Il()),this.grounded){let e=n.floorAt(this.x,this.y+.05);e<this.y-.02?(this.grounded=!1,this.vy=0,this.fallPeak=this.y):this.y=e}else{let t=this.vy>0?uu:lu,i=this.y;if(this.vy+=t*e,this.y+=this.vy*e,this.fallPeak=Math.max(this.fallPeak,this.y),this.vy<=0){let e=n.floorAt(this.x,i+.05);e!==null&&this.y<=e&&(this.y=e,this.vy=0,this.grounded=!0,this.squashT=.12,r&&r.onLand&&r.onLand(this.fallPeak-e))}}let i=this.parts;if(!this.grounded)i.armL.rotation.z=2.4,i.armR.rotation.z=2.4,i.legL.rotation.z=-.5,i.legR.rotation.z=.3,i.legL.position.y=.5,i.legR.position.y=.5;else{this.walkPhase+=e*Math.max(Math.abs(t),.001)*2.7;let n=Math.abs(t)>.2?Math.sin(this.walkPhase):0,r=Math.abs(t)>.2?Math.cos(this.walkPhase):0;i.armL.rotation.z=n*.9,i.armR.rotation.z=-n*.9,i.legL.rotation.z=-n*.9,i.legR.rotation.z=n*.9,i.legL.position.y=.5+Math.max(0,-r)*.12,i.legR.position.y=.5+Math.max(0,r)*.12}let a=this.grounded&&Math.abs(t)>.2?Math.abs(Math.cos(this.walkPhase))*.06:0,o=Math.abs(t)>.2?-Math.PI/2+Math.sign(t)*(Math.PI/2-.61):-Math.PI/2;this.faceYaw+=(o-this.faceYaw)*Math.min(1,e*5),this.group.rotation.y=this.faceYaw;let s=1;if(this.squashT>0&&(this.squashT-=e,s=.85+.15*(1-this.squashT/.12)),this.group.scale.set(1,s,1),this.group.position.set(this.x,this.y+a,0),this.stumbleT>0&&(this.stumbleT-=e,this.group.rotation.z=Math.sin(this.stumbleT*10)*.25*(this.stumbleT/.6),this.stumbleT<=0)){this.group.rotation.z=0;for(let e of this.parts.mats)e.emissive.setHex(0)}let c=n.floorAt(this.x,this.y+.05);this.shadow.position.set(this.x,c+.02,0);let l=this.y-c,u=Math.max(.4,1-l*.12);this.shadow.scale.set(u,1,u),this.shadow.material.opacity=.3*Math.max(.3,1-l*.1)}},_u={prePrimer:`a.and.away.big.blue.can.come.down.find.for.funny.go.help.here.I.in.is.it.jump.little.look.make.me.my.not.one.play.red.run.said.see.the.three.to.two.up.we.where.yellow.you`.split(`.`),primer:`all.am.are.at.ate.be.black.brown.but.came.did.do.eat.four.get.good.have.he.into.like.must.new.no.now.on.our.out.please.pretty.ran.ride.saw.say.she.so.soon.that.there.they.this.too.under.want.was.well.went.what.white.who.will.with.yes`.split(`.`),first:`after.again.an.any.as.ask.by.could.every.fly.from.give.going.had.has.her.him.his.how.just.know.let.live.may.of.old.once.open.over.put.round.some.stop.take.thank.them.then.think.walk.were.when`.split(`.`),second:`always.around.because.been.before.best.both.buy.call.cold.does.don't.fast.first.five.found.gave.goes.green.its.made.many.off.or.pull.read.right.sing.sit.sleep.tell.their.these.those.upon.us.use.very.wash.which.why.wish.work.would.write.your`.split(`.`),third:`about.better.bring.carry.clean.cut.done.draw.drink.eight.fall.far.full.got.grow.hold.hot.hurt.if.keep.kind.laugh.light.long.much.myself.never.only.own.pick.seven.shall.show.six.small.start.ten.today.together.try.warm`.split(`.`)};function vu(e,t=5){let n=Math.max(1,Math.round(e.length/t)),r=[],i=0;for(let t=0;t<n;t++){let a=Math.ceil((e.length-i)/(n-t));r.push(e.slice(i,i+a)),i+=a}return r}var yu=[{name:`Grass Plains`,emoji:`🌿`,tier:`prePrimer`},{name:`Sandy Desert`,emoji:`🏜️`,tier:`primer`},{name:`Snowy Peaks`,emoji:`❄️`,tier:`first`},{name:`Crystal Caves`,emoji:`💎`,tier:`second`},{name:`Sky Islands`,emoji:`☁️`,tier:`third`}].map(e=>({...e,levels:vu(_u[e.tier])}));function bu(e,t){return yu[e].levels[t]}function xu(e){let t=e.slice();for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function Su(e,t){let n=xu(e),r=[],i=[];for(let e of n){let n=t?t(e):null;n&&n.missed>0?r.push(e):i.push(e)}return r.concat(i)}function Cu(e,t,n){let r=new Set([e.toLowerCase()]),i=t.filter(e=>!r.has(e.toLowerCase()));if(i.length<2&&n)for(let e of n)!r.has(e.toLowerCase())&&!i.includes(e)&&i.push(e);return i=xu(i),i.sort((t,n)=>Math.abs(t.length-e.length)-Math.abs(n.length-e.length)),xu(i.slice(0,4)).slice(0,2)}function wu(e,t){let n=_u[yu[e].tier],r=n.map(e=>{let n=t?t(e):null;return{w:e,ratio:n&&n.seen>0?n.firstTryCorrect/n.seen:2,r:Math.random()}});r.sort((e,t)=>e.ratio-t.ratio||e.r-t.r);let i=r.filter(e=>e.ratio<=1).slice(0,10).map(e=>e.w),a=xu(n.filter(e=>!i.includes(e)));for(;i.length<10&&a.length;)i.push(a.pop());return i}function Tu(e,t){return wu(e,t).slice(0,5)}var Eu=[`Great job!`,`You got it!`,`Awesome!`,`Super reading!`],Du=new ji(1,1,1);function Ou(e,t,n=`normal`){let r=e.getContext(`2d`),i=e.width,a=e.height;r.fillStyle=n===`gray`?`#b9b9b9`:`#ffffff`,r.fillRect(0,0,i,a),r.lineWidth=10,r.strokeStyle=n===`check`?`#2f9e42`:`#000000`,r.strokeRect(6,6,i-12,a-12),r.fillStyle=n===`check`?`#2f9e42`:n===`gray`?`#7c7c7c`:`#000000`;let o=n===`check`?`✓`:t,s=n===`check`?a*.8:a*.62,c=e=>`bold ${e}px 'Arial Rounded MT Bold', 'Comic Sans MS', Arial, sans-serif`;for(r.font=c(s);r.measureText(o).width>i-44&&s>24;)s-=6,r.font=c(s);r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(o,i/2,a/2+4)}function ku(e,t){let n=document.createElement(`canvas`);n.width=288,n.height=144;let r=new Di(n);r.colorSpace=ze,r.anisotropy=4;let i=new q(new Ni(e,t),new Vr({map:r,side:2}));return i.userData.canvas=n,i.userData.tex=r,i}function Au(e,t,n){Ou(e.userData.canvas,t,n),e.userData.tex.needsUpdate=!0}function ju(e){e.traverse(e=>{e.geometry&&e.geometry!==Du&&e.geometry.dispose(),e.material&&!Array.isArray(e.material)&&(e.material.map&&e.material.map.dispose(),e.material.dispose())}),e.parent&&e.parent.remove(e)}var Mu=class{constructor(e,t,{x:n,word:r,distractors:i}){this.type=`blocks`,this.word=r,this.x=n,this.done=!1,this.attempts=0,this.respawns=0,this.level=t,this.explodeT=-1,this.group=new cn,e.add(this.group),this.blocks=[];let a=new J({color:16757504,emissive:4008960});for(let e=0;e<3;e++){let e=new cn,t=new q(Du,a.clone());t.scale.setScalar(1.4);let n=ku(2.1,1.05);n.position.z=.78,e.add(t,n),this.group.add(e),this.blocks.push({g:e,cube:t,sign:n,word:``,dead:!1,bounceT:0,shakeT:0,baseY:0})}this.pool=[r,...i],this.place(n+6)}place(e){let t=xu(this.pool);for(let n=0;n<3;n++){let r=this.blocks[n],i=e+n*5;r.baseY=this.level.groundTopAt(i)+3.1,r.g.position.set(i,r.baseY,0),r.word=t[n],r.dead=!1,r.bounceT=0,r.shakeT=0,r.cube.material.color.setHex(16757504),Au(r.sign,r.word,`normal`)}this.firstX=e,this.lastX=e+10}update(e,t,n){let r=performance.now()/1e3;for(let t of this.blocks){let n=t.baseY+Math.sin(r*2+t.g.position.x)*.08;t.bounceT>0&&(t.bounceT-=e,n+=Math.sin((1-t.bounceT/.3)*Math.PI)*.55),t.shakeT>0&&(t.shakeT-=e,t.g.position.x+=Math.sin(t.shakeT*50)*.05),t.g.position.y=n}if(this.explodeT>0&&(this.explodeT-=e,this.explodeT<=0&&this.explode(n)),!this.done){if(t.vy>0){let r=t.y+cu,i=r-t.vy*e;for(let e of this.blocks){if(e.dead)continue;let a=e.baseY-.7;if(i<=a+.1&&r>=a-.1&&Math.abs(t.x-e.g.position.x)<1.05){t.vy=-1.5,e.word===this.word?this.resolveCorrect(e,n):this.resolveWrong(e,n);return}}}t.x>this.lastX+2.2&&(this.respawns<1?(this.respawns++,this.place(this.lastX+7)):(this.place(this.firstX),n.bounceBack(this.firstX-4)),n.speakWord())}}resolveCorrect(e,t){this.done=!0,e.bounceT=.3,Au(e.sign,``,`check`),Pl();let n=e.g.position.clone();t.effects.confetti(n);for(let e=0;e<3;e++)t.effects.sparkle(new U(n.x+(e-1)*.5,n.y+1,0));t.effects.floatText(new U(n.x,n.y+1.6,0),`+3`),t.addCoins(3),t.praise(),t.onCorrect(this.attempts===0),this.explodeT=2.2}explode(e){Ll();for(let t of this.blocks)t.g.visible&&(e.effects.confetti(t.g.position.clone()),t.g.visible=!1)}resolveWrong(e,t){this.attempts++,e.dead=!0,e.shakeT=.4,e.cube.material.color.setHex(9079434),Au(e.sign,e.word,`gray`),Bl(),t.onWrong&&t.onWrong(),su(`Almost! The word is: ${this.word}. Try again!`,{rate:.9})}clampX(){return 1/0}debugResolve(e,t){let n=this.blocks.find(t=>!t.dead&&(e?t.word===this.word:t.word!==this.word));n&&(e?this.resolveCorrect(n,t):this.resolveWrong(n,t))}passedX(){return this.explodeT>0?1/0:this.lastX+4}dispose(){ju(this.group)}},Nu=[0,2,4],Pu=class{constructor(e,t,{x:n,wallX:r,groundY:i,word:a,distractors:o}){this.type=`doors`,this.word=a,this.x=n,this.wallX=r,this.groundY=i,this.done=!1,this.opened=-1,this.attempts=0,this.cooldown=0,this.group=new cn,this.group.position.set(r,i,0),e.add(this.group);let s=new J({color:9263659}),c=new J({color:11104059});for(let e of[-1,1])for(let t=0;t<7;t++){let n=new q(Du,t+e&1?s:c);n.position.set(0,t+.5,e),this.group.add(n)}for(let e=-1;e<=1;e++){let t=new q(Du,c);t.position.set(0,6.75,e),t.scale.set(1.3,.5,1),this.group.add(t)}let l=xu([a,...o]);this.doors=Nu.map((e,t)=>{let n=new cn;n.position.set(0,e,-.7);let r=new q(Du,new J({color:11893052}));r.scale.set(.7,1.9,1.4),r.position.set(0,.95,.7);let i=new q(Du,new J({color:16766282}));i.scale.setScalar(.2),i.position.set(-.44,.95,1.1),n.add(r,i),this.group.add(n);let a=ku(1.9,.95);return a.position.set(-1.6,e+1.15,1.3),Au(a,l[t],`normal`),this.group.add(a),{hinge:n,sign:a,word:l[t],tier:e,dead:!1,shakeT:0,openT:-1}})}update(e,t,n){this.cooldown-=e;for(let t of this.doors)t.shakeT>0&&(t.shakeT-=e,t.hinge.rotation.y=Math.sin(t.shakeT*40)*.08,t.shakeT<=0&&(t.hinge.rotation.y=0)),t.openT>=0&&t.openT<1&&(t.openT=Math.min(1,t.openT+e*2.2),t.hinge.rotation.y=-(1-(1-t.openT)**3)*1.9);if(!this.done){if(this.opened===-1&&this.cooldown<=0&&t.grounded&&t.x>this.wallX-1.35){let e=t.y-this.groundY,r=Nu.findIndex(t=>Math.abs(e-t)<.7);r>=0&&this.resolveTier(r,n)}this.opened!==-1&&t.x>this.wallX+2&&(this.done=!0)}}resolveTier(e,t){let n=this.doors[e];n.word===this.word?(this.opened=e,n.openT=0,Ul(),t.effects.confetti(new U(this.wallX,this.groundY+n.tier+1.5,.5)),t.effects.floatText(new U(this.wallX,this.groundY+n.tier+2.6,0),`+3`),t.addCoins(3),t.praise(),t.onCorrect(this.attempts===0)):(this.attempts++,n.dead=!0,n.shakeT=.4,Au(n.sign,n.word,`gray`),Fl(),this.cooldown=1.4,t.bounceBack(this.wallX-8),su(`Almost! The word is: ${this.word}. Try again!`,{rate:.9}))}clampX(){return this.opened===-1?this.wallX-.85:1/0}debugResolve(e,t){if(this.opened!==-1)return;let n=this.doors.findIndex(t=>!t.dead&&(e?t.word===this.word:t.word!==this.word));n>=0&&this.resolveTier(n,t)}passedX(){return this.wallX+4}dispose(){ju(this.group)}};function Fu(){let e=new cn,t=new J({color:16766282,emissive:7820544}),n=new q(Du,t);n.scale.setScalar(.7);let r=new q(Du,t);return r.scale.setScalar(.7),r.rotation.z=Math.PI/4,e.add(n,r),e}var Iu=class{constructor(e,t,{x:n,reviews:r,onGem:i,onDone:a}){this.type=`stars`,this.level=t,this.x=n,this.reviews=r,this.onGem=i,this.onDone=a,this.idx=0,this.done=!1,this.warned=!1,this.pending=0,this.group=new cn,e.add(this.group),this.stars=[0,1].map(()=>{let e=new cn,t=Fu(),n=ku(1.8,.9);return n.position.y=-1.15,e.add(t,n),this.group.add(e),{holder:e,star:t,sign:n,word:``,taken:!1}}),r.length?this.present(n+5):this.finish()}get word(){let e=this.reviews[this.idx];return e?e.word:``}present(e){let t=this.reviews[this.idx],n=xu([t.word,t.distractor]),r=xu([2.3,3.5]);for(let t=0;t<2;t++){let i=this.stars[t],a=e+t*5;i.holder.position.set(a,this.level.groundTopAt(a)+r[t],0),i.holder.visible=!0,i.word=n[t],i.taken=!1,Au(i.sign,i.word,`normal`)}this.lastX=e+5,this.warned=!1}update(e,t,n){let r=performance.now()/1e3;for(let t of this.stars)t.star.rotation.y+=e*2,t.holder.position.y+=Math.sin(r*3+t.holder.position.x)*.003;if(!this.done){if(this.pending>0){this.pending-=e,this.pending<=0&&(this.present(t.x+5),n.speakWord());return}for(let e of this.stars){if(e.taken||!e.holder.visible)continue;let r=Math.abs(t.x-e.holder.position.x),i=e.holder.position.y;if(r<.85&&t.y+1.7>i-.5&&t.y<i+.6){e.taken=!0,e.word===this.word?this.grabCorrect(e,n):this.grabWrong(e,n);return}}t.x>this.lastX+2.2&&(this.warned?this.advance(n):(this.warned=!0,this.present(t.x+5),n.speakWord()))}}grabCorrect(e,t){Jl(),t.effects.confetti(e.holder.position.clone()),t.effects.floatText(new U(e.holder.position.x,e.holder.position.y+1.2,0),`+1`),this.onGem(),t.praise();for(let e of this.stars)e.holder.visible=!1;this.advance(t,!0)}grabWrong(e,t){e.holder.visible=!1,Fl(),this.warned?this.advance(t):(this.warned=!0,su(`Almost! The word is: ${this.word}.`,{rate:.9}))}advance(e,t=!1){this.idx++;for(let e of this.stars)e.holder.visible=!1;this.idx>=this.reviews.length?this.finish():this.pending=t?.7:.25}finish(){this.done=!0;for(let e of this.stars)e.holder.visible=!1;this.onDone&&this.onDone()}clampX(){return 1/0}debugResolve(e,t){let n=this.stars.find(t=>!t.taken&&(e?t.word===this.word:t.word!==this.word));n&&(n.taken=!0,e?this.grabCorrect(n,t):this.grabWrong(n,t))}dispose(){ju(this.group)}},Lu=new ji(1,1,1),Ru=10.5,zu=[{name:`Grass Golem`,color:5027141},{name:`Sand Serpent`,color:14660702},{name:`Frost Yeti`,color:15660799},{name:`Crystal Golem`,color:10448852},{name:`Cloud Dragon`,color:12575999}];function Bu(e){let t=new cn,n=(e,t=0)=>new J({color:e,emissive:t}),r=(e,t,n,r,i,a,o,s,c=0)=>{let l=new q(Lu,t);return l.scale.set(n,r,i),l.position.set(a,o,s),l.rotation.z=c,e.add(l),l},i=(e,t,i,a=1)=>{let o=n(16777215),s=n(2236962);for(let n of[-.32,.32])r(e,o,.34*a,.34*a,.1,n*a,t+.1*a,i),r(e,s,.16*a,.16*a,.1,n*a,t+.08*a,i+.07);r(e,s,.5*a,.12,.08,0,t-.34*a,i)},a=(e,n,i,a,o)=>{let s=new cn;return s.position.set(e,n,0),r(s,i,a,o,a,0,-o/2,0),t.add(s),s},o=[],s=[],c=5;if(e===0){let e=n(5027141);r(t,n(4169274),.9,1,.9,-.65,.5,0),r(t,n(4169274),.9,1,.9,.65,.5,0),r(t,e,2.6,2.2,1.6,0,2.1,0),r(t,n(9425759),2.9,.45,1.8,0,3.25,0),r(t,n(7323490),1.6,1.2,1.4,0,4.15,0),r(t,n(4169274),.55,.4,.55,.45,4.9,0),r(t,n(16739201),.28,.28,.28,-.5,4.9,.25),o.push(a(-1.65,3.2,e,.7,1.9),a(1.65,3.2,e,.7,1.9)),i(t,4.25,.75,1.1),s=[[-1.04,1.55,.85],[-.52,1.55,.88],[0,1.55,.9],[.52,1.55,.88],[1.04,1.55,.85]],c=5}else if(e===1){let e=n(14660702),a=n(13806935);r(t,a,2.5,1.1,1.9,0,.55,0),r(t,e,2,1.05,1.5,.25,1.55,0),r(t,a,1.7,1.05,1.3,-.2,2.55,0),r(t,e,1.4,1.05,1.1,.15,3.55,0);let l=new cn;l.position.set(0,4.1,0),r(l,n(13082700),2.1,1.3,.6,0,.55,-.35),r(l,n(15651982),1.3,1.05,1.1,0,.5,.15),r(l,n(15684432),.12,.08,.5,0,.15,.82),i(l,.6,.74,.9),t.add(l),o.push(l),s=[[0,.7,1.05],[.25,1.55,.85],[-.2,2.55,.75],[.15,3.55,.68],[0,4.6,.85]],c=5.2}else if(e===2){let e=n(16777215);r(t,n(15660799),1,.9,1,-.7,.45,0),r(t,n(15660799),1,.9,1,.7,.45,0),r(t,e,2.7,2.4,1.8,0,2.1,0),r(t,n(14412279),1.7,1.3,.2,0,1.9,.88),r(t,e,1.7,1.3,1.5,0,4,0),r(t,n(11190998),1.3,.85,.15,0,4.05,.74),r(t,n(10470632),.3,.5,.3,-.55,4.85,0),r(t,n(10470632),.3,.5,.3,.55,4.85,0),o.push(a(-1.8,3.4,e,.85,2.3),a(1.8,3.4,e,.85,2.3)),i(t,4.1,.84,1),s=[[-1,1.5,1],[-.5,1.5,1.02],[0,1.5,1.05],[.5,1.5,1.02],[1,1.5,1]],c=5.1}else if(e===3){let e=n(6184556);r(t,n(5526623),.85,1,.85,-.6,.5,0),r(t,n(5526623),.85,1,.85,.6,.5,0),r(t,e,2.4,2,1.5,0,2,0),r(t,n(7237244),1.4,1.1,1.2,0,3.75,0),r(t,n(8319231,1793907),.4,1.4,.4,-1.25,3.3,0,.5),r(t,n(13663999,5446515),.4,1.4,.4,1.25,3.3,0,-.5),r(t,n(16747224,7543635),.32,1,.32,0,4.75,0),r(t,n(8319231,1793907),.28,.8,.28,-.5,4.6,0,.3),r(t,n(13663999,5446515),.28,.8,.28,.5,4.6,0,-.3),o.push(a(-1.5,2.9,e,.7,1.8),a(1.5,2.9,e,.7,1.8)),i(t,3.85,.64,1),s=[[-.96,1.45,.8],[-.48,1.45,.83],[0,1.45,.86],[.48,1.45,.83],[.96,1.45,.8]],c=5.2}else{let e=n(16777215),a=n(12575999);r(t,e,2.8,.7,1.9,0,.5,0),r(t,n(15923455),1.2,.6,1.2,-1.1,.75,.3),r(t,n(15923455),1,.55,1,1.15,.7,-.2),r(t,a,1.9,1.7,1.4,0,2,0),r(t,n(10474239),.8,1,.8,0,3.3,.1),r(t,a,1.35,1,1.2,0,4.2,.2),r(t,n(10474239),.7,.5,.7,0,4,.9),r(t,n(16766282),.22,.5,.22,-.35,4.9,0),r(t,n(16766282),.22,.5,.22,.35,4.9,0),r(t,a,.9,.5,.9,-1.25,1.6,-.3);let l=n=>{let i=new cn;return i.position.set(n*1.05,2.6,0),r(i,e,1.9,.18,1,n*1,0,0),t.add(i),i};o.push(l(-1),l(1)),i(t,4.4,.82,.9),s=[[-.76,2,.75],[-.38,2,.78],[0,2,.8],[.38,2,.78],[.76,2,.75]],c=5.2}return t.rotation.y=-.42,{group:t,arms:o,armor:s,top:c}}function Vu(){let e=new cn,t=new J({color:16766282,emissive:7820544}),n=new q(Lu,t);n.scale.set(.85,.3,.85),e.add(n);for(let n of[-.3,0,.3]){let r=new q(Lu,t);r.scale.set(.18,.32,.18),r.position.set(n,.3,0),e.add(r)}let r=new q(Lu,new J({color:15684432,emissive:5574929}));return r.scale.setScalar(.2),r.position.set(0,0,.44),e.add(r),e}var Hu=class{constructor(e,t,n,r){this.scene=e,this.effects=n,this.level=r,this.def=zu[t],this.hp=5,this.state=`enter`,this.t=0,this.throwCool=2.5,this.stepPhase=0;let i=Bu(t);this.group=i.group,this.arms=i.arms,this.top=i.top,e.add(this.group),this.armor=i.armor.map(([e,t,n])=>{let r=new q(Lu,new J({color:16766282,emissive:6704384}));return r.scale.setScalar(.5),r.position.set(e,t,n),this.group.add(r),{m:r,popT:-1,vx:0,vy:0}}),this.projectiles=[0,1].map(()=>{let t=new q(Lu,new J({color:this.def.color,emissive:3351040}));return t.scale.setScalar(.8),t.visible=!1,e.add(t),{m:t,on:!1,mode:`held`,t:0,x:0,y:0,x0:0,y0:0,x1:0,dur:1.35}}),this.crown=Vu(),this.crown.visible=!1,e.add(this.crown),this.coinTimer=0}enterAt(e){this.holdX=e,this.x=e+8}settle(){(this.state===`enter`||this.state===`roar`)&&(this.x=this.holdX,this.state=`idle`,this.t=0)}clearHeld(){for(let e of this.projectiles)e.on&&e.mode===`held`&&(e.on=!1,e.m.visible=!1)}hit(){this.hp--;let e=this.armor[this.hp];if(e){e.popT=0,e.vx=-3-Math.random()*2,e.vy=7;let t=new U;e.m.getWorldPosition(t),this.effects.confetti(t),this.effects.sparkle(t)}ql(),this.clearHeld(),this.state=`hurt`,this.t=0}taunt(){this.state!==`idle`&&this.state!==`dizzy`||(this.clearHeld(),Kl(),this.state=`taunt`,this.t=0)}startDefeat(e,t){this.clearHeld();for(let e of this.projectiles)e.on=!1,e.m.visible=!1;this.state=`defeat`,this.t=0,this.coinTimer=0,Rl(),this.effects.fireworks(new U(this.x,3,0)),e.addCoins(10),this.effects.floatText(new U(this.x,this.top+1,0),`+10`)}updateProjectiles(e,t,n){for(let r of this.projectiles)if(r.on){if(r.mode===`held`)r.x=this.x,r.y=this.group.position.y+this.top+.9,r.m.scale.setScalar(.6+Math.abs(Math.sin(r.t*14))*.35),r.t+=e;else if(r.mode===`fly`){r.t+=e;let t=Math.min(1,r.t/r.dur);r.x=r.x0+(r.x1-r.x0)*t;let n=this.level.groundTopAt(r.x1)+.4;r.y=r.y0+(n-r.y0)*t+Math.sin(t*Math.PI)*3.4,r.m.rotation.z-=e*7,t>=1&&(r.mode=`roll`,r.t=0,Vl(),this.effects.sparkle(new U(r.x,r.y,0)))}else if(r.t+=e,r.x-=e*2.4,r.y=this.level.groundTopAt(r.x)+.4,r.m.rotation.z+=e*6,r.t>2.4||r.x<t.x-2.5){r.on=!1,r.m.visible=!1,this.effects.sparkle(new U(r.x,r.y,0));continue}r.mode!==`held`&&Math.abs(r.x-t.x)<.75&&t.y<r.y+.6&&t.y+1.7>r.y-.6&&(r.on=!1,r.m.visible=!1,this.effects.sparkle(new U(r.x,r.y,0)),n.stumble()),r.m.position.set(r.x,r.y,0)}}update(e,t,n,{battle:r=!1,challengeActive:i=!1,minX:a=0}={}){this.t+=e;let o=this.group;for(let t of this.armor)t.popT<0||(t.popT+=e,t.vy-=20*e,t.m.position.x+=t.vx*e,t.m.position.y+=t.vy*e,t.m.rotation.z+=e*9,t.popT>.9&&(t.m.visible=!1,t.popT=-1));this.updateProjectiles(e,t,n);let s=0,c=0,l=1,u=[0,0];if(this.state===`enter`){this.x=Math.max(this.holdX,this.x-e*5),s=Math.abs(Math.sin(this.t*9))*.35;let t=Math.floor(this.t*9/Math.PI);t!==this.stepPhase&&(this.stepPhase=t,Vl()),this.x<=this.holdX&&(this.state=`roar`,this.t=0,Gl())}else if(this.state===`roar`){let e=Math.min(1,this.t/1);l=1+Math.sin(e*Math.PI)*.16,u[0]=Math.sin(e*Math.PI)*2.2,u[1]=-Math.sin(e*Math.PI)*2.2,c=Math.sin(this.t*24)*.04*(1-e),e>=1&&(this.state=`idle`,this.t=0)}else if(this.state===`idle`||this.state===`dizzy`){let n=Math.max(this.x,t.x+Ru,a),o=Math.min(e*6,n-this.x);if(this.x+=o,s=o>.01?Math.abs(Math.sin(this.t*8))*.25:Math.sin(this.t*2.2)*.1,c=Math.sin(this.t*(this.state===`dizzy`?3:1.7))*(this.state===`dizzy`?.14:.05),u[0]=Math.sin(this.t*2)*.18,u[1]=-Math.sin(this.t*2)*.18,this.throwCool-=e,r&&!i&&this.state===`idle`&&this.throwCool<=0){let e=this.projectiles.find(e=>!e.on);e&&(e.on=!0,e.mode=`held`,e.t=0,e.m.visible=!0,e.m.rotation.z=0,this.state=`windup`,this.t=0)}}else if(this.state===`windup`){let e=Math.min(1,this.t/.8);if(u[0]=e*2.4,s=Math.sin(this.t*2.2)*.1,e>=1){let e=this.projectiles.find(e=>e.on&&e.mode===`held`);e&&(e.mode=`fly`,e.t=0,e.x0=this.x,e.y0=this.group.position.y+this.top+.9,e.x1=Math.min(t.x+4.5,this.x-3),e.m.scale.setScalar(.8)),this.throwCool=3.4,this.state=`idle`,this.t=0}}else if(this.state===`hurt`){let e=Math.min(1,this.t/1);c=-Math.sin(e*Math.PI)*.4,s=-Math.sin(e*Math.PI)*.25,u[0]=Math.sin(e*Math.PI)*1.4,u[1]=-Math.sin(e*Math.PI)*1.4,e>=1&&(this.state=this.hp>0?`idle`:`dizzy`,this.t=0)}else if(this.state===`taunt`){let e=Math.min(1,this.t/.9);o.rotation.y=-.42+Math.sin(this.t*14)*.3*(1-e),l=1-Math.sin(e*Math.PI)*.12,e>=1&&(o.rotation.y=-.42,this.state=this.hp>0?`idle`:`dizzy`,this.t=0)}else if(this.state===`defeat`){let t=Math.min(1,this.t/2.4);c=Math.sin(this.t*8)*.2*t,s=-t*t*2.4,l=1-t*.4,this.coinTimer-=e,this.coinTimer<=0&&(this.coinTimer=.18,this.effects.confetti(new U(this.x+(Math.random()-.5)*2,this.top*(1-t)+1,0)),Nl()),t>=1&&(o.visible=!1,this.state=`crownDrop`,this.t=0,this.crown.visible=!0,this.crown.position.set(this.x,this.top+1,0))}else if(this.state===`crownDrop`){let n=Math.min(1,this.t/.9),r=1-(1-n)**3,i=t.x,a=t.y+cu+.25;this.crown.position.x+=(i-this.crown.position.x)*r,this.crown.position.y=this.crown.position.y+(a-this.crown.position.y)*r+Math.sin(n*Math.PI)*.6*e,this.crown.rotation.y+=e*4,n>=1&&(this.state=`gone`,this.effects.sparkle(this.crown.position.clone()),Nl())}else this.crown.position.set(t.x,t.y+cu+.25,0),this.crown.rotation.y+=e*1.5;if(o.visible){let e=this.level.groundTopAt(this.x);o.position.set(this.x,e+s,0),o.rotation.z=c,o.scale.setScalar(l),this.arms.forEach((e,t)=>{e.rotation.z=(t===0?1:-1)*u[t]})}}dispose(){ju(this.group),ju(this.crown);for(let e of this.projectiles)e.m.material.dispose(),this.scene.remove(e.m)}},Uu=90,Wu=8,Gu=8,Ku=[16732754,16766784,6942894,4244735,14696699,16755520],qu=class{constructor(e){this.positions=new Float32Array(Uu*3),this.velocities=new Float32Array(Uu*3),this.colors=new Float32Array(Uu*3);let t=new dr;t.setAttribute(`position`,new Xn(this.positions,3)),t.setAttribute(`color`,new Xn(this.colors,3)),this.material=new yi({size:.22,vertexColors:!0,transparent:!0,opacity:1,depthWrite:!1}),this.points=new wi(t,this.material),this.points.visible=!1,this.points.frustumCulled=!1,this.life=0,this.maxLife=1,this.gravity=-9,e.add(this.points)}fire(e,{speed:t=6,up:n=5,life:r=1.1,gravity:i=-9,count:a=Uu}={}){this.count=Math.min(a,Uu);let o=new K;for(let r=0;r<this.count;r++){let i=r*3;this.positions[i]=e.x,this.positions[i+1]=e.y,this.positions[i+2]=e.z;let a=Math.random()*Math.PI*2,s=Math.random()*t;this.velocities[i]=Math.cos(a)*s,this.velocities[i+1]=Math.random()*n+1,this.velocities[i+2]=Math.sin(a)*s,o.setHex(Ku[Math.random()*Ku.length|0]),this.colors[i]=o.r,this.colors[i+1]=o.g,this.colors[i+2]=o.b}this.points.geometry.setDrawRange(0,this.count),this.points.geometry.attributes.position.needsUpdate=!0,this.points.geometry.attributes.color.needsUpdate=!0,this.life=r,this.maxLife=r,this.gravity=i,this.points.visible=!0}update(e){if(this.points.visible){if(this.life-=e,this.life<=0){this.points.visible=!1;return}for(let t=0;t<this.count;t++){let n=t*3;this.velocities[n+1]+=this.gravity*e,this.positions[n]+=this.velocities[n]*e,this.positions[n+1]+=this.velocities[n+1]*e,this.positions[n+2]+=this.velocities[n+2]*e}this.points.geometry.attributes.position.needsUpdate=!0,this.material.opacity=Math.min(1,this.life/this.maxLife*2)}}};function Ju(e){let t=document.createElement(`canvas`);t.width=128,t.height=64;let n=t.getContext(`2d`);n.font=`bold 44px Arial Rounded MT Bold, Arial, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.lineWidth=8,n.strokeStyle=`#2c3e75`,n.strokeText(e,64,32),n.fillStyle=`#ffd93d`,n.fillText(e,64,32);let r=new Di(t);return r.colorSpace=ze,r}var Yu=class{constructor(e){this.scene=e,this.bursts=[];for(let t=0;t<Wu;t++)this.bursts.push(new qu(e));this.burstIdx=0,this.textures=new Map,this.sprites=[];for(let t=0;t<Gu;t++){let t=new jr(new _r({transparent:!0,depthWrite:!1}));t.scale.set(1.4,.7,1),t.visible=!1,t.userData.life=0,e.add(t),this.sprites.push(t)}this.pendingFireworks=[]}nextBurst(){let e=this.bursts[this.burstIdx];return this.burstIdx=(this.burstIdx+1)%this.bursts.length,e}confetti(e){this.nextBurst().fire(e,{speed:5,up:7,life:1.4,gravity:-10})}sparkle(e){this.nextBurst().fire(e,{speed:2.5,up:3,life:.6,gravity:-4,count:30})}fireworks(e){for(let t=0;t<6;t++)this.pendingFireworks.push({t:t*.35,pos:new U(e.x+(Math.random()-.5)*10,e.y+4+Math.random()*4,e.z-6-Math.random()*8)})}floatText(e,t){this.textures.has(t)||this.textures.set(t,Ju(t));let n=this.sprites.find(e=>!e.visible)||this.sprites[0];n.material.map=this.textures.get(t),n.material.opacity=1,n.position.copy(e),n.userData.life=.9,n.visible=!0}update(e){for(let t of this.bursts)t.update(e);for(let t of this.sprites)if(t.visible){if(t.userData.life-=e,t.userData.life<=0){t.visible=!1;continue}t.position.y+=1.6*e,t.material.opacity=Math.min(1,t.userData.life*2)}if(this.pendingFireworks.length){for(let t of this.pendingFireworks)t.t-=e;let t=this.pendingFireworks.filter(e=>e.t<=0);if(t.length){this.pendingFireworks=this.pendingFireworks.filter(e=>e.t>0);for(let e of t)this.nextBurst().fire(e.pos,{speed:6,up:3,life:1.6,gravity:-5})}}}},Xu={ArrowLeft:-1,KeyA:-1,ArrowRight:1,KeyD:1};function Zu(e,t){let n=!1,r=!1,i=new Set,a={"-1":!1,1:!1},o=()=>{for(let e of[-1,1]){let n=[...i].some(t=>Xu[t]===e);n!==a[e]&&(a[e]=n,t.onMove&&t.onMove(e,n))}},s=e=>{e.target&&e.target.closest&&e.target.closest(`button`)||(e.preventDefault(),!n&&!r&&t.onJump(),n=!0)},c=()=>{n=!1},l=e=>{if(e.code in Xu){e.preventDefault(),i.add(e.code),o();return}e.code!==`Space`&&e.code!==`ArrowUp`&&e.code!==`KeyW`||(e.preventDefault(),!(e.repeat||r)&&(n||t.onJump(),r=!0))},u=e=>{if(e.code in Xu){i.delete(e.code),o();return}e.code!==`Space`&&e.code!==`ArrowUp`&&e.code!==`KeyW`||(r=!1)};return window.PointerEvent?(e.addEventListener(`pointerdown`,s),window.addEventListener(`pointerup`,c),window.addEventListener(`pointercancel`,c)):(e.addEventListener(`touchstart`,s,{passive:!1}),window.addEventListener(`touchend`,c),window.addEventListener(`touchcancel`,c),e.addEventListener(`mousedown`,s),window.addEventListener(`mouseup`,c)),window.addEventListener(`keydown`,l),window.addEventListener(`keyup`,u),{destroy(){e.removeEventListener(`pointerdown`,s),window.removeEventListener(`pointerup`,c),window.removeEventListener(`pointercancel`,c),e.removeEventListener(`touchstart`,s),window.removeEventListener(`touchend`,c),window.removeEventListener(`touchcancel`,c),e.removeEventListener(`mousedown`,s),window.removeEventListener(`mouseup`,c),window.removeEventListener(`keydown`,l),window.removeEventListener(`keyup`,u)}}}var Qu=t({addCoins:()=>ld,addGems:()=>ud,beatBoss:()=>bd,completeLevel:()=>xd,devUnlockAll:()=>Td,foundKey:()=>gd,get:()=>id,getSecretStars:()=>pd,getStars:()=>dd,hasKey:()=>hd,isBossBeaten:()=>yd,isLevelUnlocked:()=>Sd,isMastered:()=>cd,isSecretUnlocked:()=>_d,isWorldUnlocked:()=>Cd,keyAnchorLevel:()=>vd,load:()=>nd,recordWordResult:()=>sd,reset:()=>wd,save:()=>rd,setMic:()=>Dd,setSecretStars:()=>md,setSound:()=>Ed,setStars:()=>fd,wordStats:()=>ad}),$u=`wordRunner.v3`,ed=[`wordRunner.v2`,`wordRunner.v1`],td=()=>({coins:0,gems:0,sound:!0,mic:!0,devUnlocked:!1,words:{},stars:{},unlocked:{world:0,level:0},keys:{},secretUnlocked:{},secretStars:{},bossBeaten:{}}),Z=td();function nd(){try{let e=localStorage.getItem($u);if(e)Z={...td(),...JSON.parse(e)};else{let e=ed.map(e=>localStorage.getItem(e)).find(Boolean);if(e){Z={...td(),...JSON.parse(e)};for(let e=0;e<Z.unlocked.world;e++)Z.bossBeaten[e]=!0;rd()}}}catch{Z=td()}return Z}function rd(){try{localStorage.setItem($u,JSON.stringify(Z))}catch{}}function id(){return Z}function ad(e){return Z.words[e.toLowerCase()]||null}function od(e){let t=e.toLowerCase();return Z.words[t]||(Z.words[t]={seen:0,correct:0,firstTryCorrect:0,missed:0}),Z.words[t]}function sd(e,t){let n=od(e);n.seen++,n.correct++,t?n.firstTryCorrect++:n.missed++,rd()}function cd(e){let t=ad(e);return!!t&&t.firstTryCorrect>=3}function ld(e){return Z.coins=Math.max(0,Z.coins+e),rd(),Z.coins}function ud(e){return Z.gems=Math.max(0,Z.gems+e),rd(),Z.gems}function dd(e,t){return Z.stars[`${e}-${t}`]||0}function fd(e,t,n){let r=`${e}-${t}`;Z.stars[r]=Math.max(Z.stars[r]||0,n),rd()}function pd(e){return Z.secretStars[e]||0}function md(e,t){Z.secretStars[e]=Math.max(Z.secretStars[e]||0,t),rd()}function hd(e,t){return!!Z.keys[`${e}-${t}`]}function gd(e,t){Z.keys[`${e}-${t}`]=!0,Z.secretUnlocked[e]=!0,rd()}function _d(e){return Z.devUnlocked||!!Z.secretUnlocked[e]}function vd(e){for(let t of Object.keys(Z.keys)){let[n,r]=t.split(`-`).map(Number);if(n===e)return r}return null}function yd(e){return!!Z.bossBeaten[e]}function bd(e){Z.bossBeaten[e]=!0,rd()}function xd(e,t,n){let r=Z.unlocked;e===r.world&&t===r.level&&(t+1<=n[e]?r.level++:e+1<n.length&&(r.world++,r.level=0)),rd()}function Sd(e,t){if(Z.devUnlocked)return!0;let n=Z.unlocked;return e<n.world||e===n.world&&t<=n.level}function Cd(e){return Z.devUnlocked||e<=Z.unlocked.world}function wd(){try{for(let e of[$u,...ed])localStorage.removeItem(e)}catch{}Z=td()}function Td(e=5){Z.devUnlocked=!0;for(let t=0;t<e;t++)Z.bossBeaten[t]=!0;rd()}function Ed(e){Z.sound=e,rd()}function Dd(e){Z.mic=e,rd()}var Od=4.5,kd=2.5,Ad=3.4,jd=[16744272,12216520,5099745,10463450,16758605],Md=new ji(1,1,1);function Nd(){let e=new cn,t=new J({color:16744272}),n=new q(Md,t);n.scale.set(.95,.6,.7),n.position.y=.45;let r=new q(Md,t);r.scale.set(.65,.3,.55),r.position.y=.85;let i=new J({color:16777215}),a=new J({color:2236962});for(let t of[-.18,.18]){let n=new q(Md,i);n.scale.setScalar(.18),n.position.set(t+.25,.62,.36);let r=new q(Md,a);r.scale.setScalar(.09),r.position.set(t+.28,.62,.46),e.add(n,r)}for(let t of[-.25,.25]){let n=new q(Md,a);n.scale.set(.22,.18,.3),n.position.set(t,.09,0),e.add(n)}return e.add(n,r),e.userData.mat=t,e}function Pd(){let e=new cn,t=new J({color:16766282,emissive:7820544});for(let[n,r,i,a]of[[0,.35,.5,.12],[0,-.35,.5,.12],[-.25,0,.12,.6],[.25,0,.12,.6]]){let o=new q(Md,t);o.scale.set(i,a,.12),o.position.set(n,r+.5,0),e.add(o)}let n=new q(Md,t);n.scale.set(.12,.7,.12),n.position.y=-.3;let r=new q(Md,t);return r.scale.set(.3,.12,.12),r.position.set(.15,-.55,0),e.add(n,r),e}var Fd=class{constructor(e,t){this.cb=t,this.renderer=e,this.scene=new _n,this.camera=new xa(50,window.innerWidth/window.innerHeight,.1,120),this.camera.position.set(3,4.2,14),this.lookTarget=new U(4,3,0);let n=new la(16777215,8956518,1.1),r=new wa(16773849,1.4);r.position.set(4,10,6),this.scene.add(n,r),this.level=new bl(this.scene),this.player=new gu(this.scene),this.effects=new Yu(this.scene),this.critters=[];for(let e=0;e<6;e++){let e=Nd();e.visible=!1,this.scene.add(e),this.critters.push({g:e,x:0,dir:1,x0:0,x1:0,state:`off`,squashT:0})}this.keyMesh=Pd(),this.keyMesh.visible=!1,this.scene.add(this.keyMesh),this.input=Zu(e.domElement,{onJump:()=>{!this.running||this.paused||(this.phase===`bossIntro`?this.endIntro():this.player.jump())},onMove:(e,t)=>this.setMove(`key`,e,t)}),this.bossFight=null,this.running=!1,this.paused=!1,this.speed=0,this.elapsed=0,this.events=[],this.activeEv=null,this.stars=null,this.choice=!1,this.moveHeld={},this.api={effects:this.effects,level:this.level,praise:()=>{su(Eu[this.praiseIdx++%Eu.length],{rate:1})},addCoins:e=>this.addCoins(e),bounceBack:e=>this.bounceBack(e),speakWord:()=>this.repeatWord(),onCorrect:e=>this.onEventCorrect(e),onWrong:()=>{this.bossFight&&this.bossFight.taunt()},stumble:()=>{Fl(),this.player.stumble(),this.stumbleMul=.4,this.addCoins(-1)}}}startRun(e,t,{secret:n=!1,boss:r=!1}={}){this.worldIdx=e,this.levelIdx=t,this.secret=n,this.isBoss=r,this.tierList=_u[yu[e].tier],this.levelWords=r?Tu(e,ad):n?wu(e,ad):bu(e,t),this.queue=Su(this.levelWords,ad),this.results=[],this.praiseIdx=0,this.runCoins=0,this.runGems=0,this.keyFound=!1;let i=e*97+t*13+(n?7:1),a=!n&&!r&&(e+t)%2==0;this.data=r?ml({seed:i,wordCount:this.queue.length,theme:e}):pl({seed:i,wordCount:this.queue.length,theme:e,secret:n,hasKey:a}),this.level.build(this.data),this.clearEvents(),this.events=this.data.events,this.eventIdx=0,this.activeEv=null,this.spoken=!1,this.stars=null,this.phase=r?`bossIntro`:`run`,this.introT=0,this.introSpoke=!1,this.repeatTimer=0,this.autoRepeats=0,this.bounce=null,this.stumbleMul=1,this.flagT=0,this.doneTimer=0;for(let t=0;t<this.critters.length;t++){let n=this.critters[t],r=this.data.critters[t];r?(n.state=`pace`,n.x0=r.x0,n.x1=r.x1,n.x=(r.x0+r.x1)/2,n.dir=1,n.squashT=0,n.g.visible=!0,n.g.scale.setScalar(1),n.g.userData.mat.color.setHex(jd[e])):(n.state=`off`,n.g.visible=!1)}this.data.key?(this.keyMesh.visible=!0,this.keyMesh.position.set(this.data.key.x,this.data.key.y,0)):this.keyMesh.visible=!1,this.player.reset(2,this.data.groundY[2]),this.speed=0,this.setChoice(!1),this.moveHeld={},this.camera.position.set(this.player.x+3,4.2,14),r&&(this.bossFight=new Hu(this.scene,e,this.effects,this.level),this.bossFight.enterAt(this.player.x+12)),this.cb.onDotsInit(this.queue.length),this.cb.onCoins(0),this.cb.onKey(!1),this.running=!0,this.paused=!1}stopRun(){this.running=!1,this.clearEvents(),this.setChoice(!1)}setMove(e,t,n){this.moveHeld[(t<0?`L`:`R`)+e]=n}get moveDir(){let e=this.moveHeld;return(e.Rkey||e.Rbtn?1:0)-(e.Lkey||e.Lbtn?1:0)}setChoice(e){this.choice!==e&&(this.choice=e,this.cb.onChoice&&this.cb.onChoice(e))}choiceZone(){let e=this.activeEv;if(e&&!e.done)return e.type===`blocks`?{engage:e.firstX-4.5,min:e.firstX-6,max:e.lastX+1.5}:{engage:e.wallX-8,min:e.wallX-10,max:1/0};if(this.stars&&!this.stars.done&&this.stars.reviews.length&&this.stars.pending<=0){let e=this.stars.stars.filter(e=>e.holder.visible&&!e.taken);if(e.length){let t=e.map(e=>e.holder.position.x);return{engage:Math.min(...t)-4,min:Math.min(...t)-5.5,max:Math.max(...t)+1.5}}}return null}clearEvents(){this.activeEv&&this.activeEv.dispose(),this.activeEv=null,this.stars&&this.stars.dispose(),this.stars=null,this.bossFight&&=(this.bossFight.dispose(),null)}pause(){this.paused=!0}resume(){this.paused=!1}currentWord(){return this.stars&&!this.stars.done?this.stars.word:this.activeEv&&!this.activeEv.done?this.activeEv.word:this.queue?this.queue[this.eventIdx]:null}get currentEvent(){return this.stars&&!this.stars.done?{type:`stars`,word:this.stars.word}:this.activeEv&&!this.activeEv.done?{type:this.activeEv.type,word:this.activeEv.word}:null}repeatWord(){let e=this.currentWord();this.running&&e&&su(`Find the word: ${e}`,{rate:.85})}get boss(){return this.bossFight?{hp:this.bossFight.hp,phase:this.bossFight.state}:null}debugResolve(e=!0){if(this.running){if(this.phase===`bossIntro`&&this.endIntro(),this.stars&&!this.stars.done){this.stars.debugResolve(e,this.api);return}!this.activeEv&&this.eventIdx<this.events.length&&this.spawnEvent(),this.activeEv&&!this.activeEv.done&&this.activeEv.debugResolve(e,this.api)}}spawnEvent(){let e=this.events[this.eventIdx],t=this.queue[this.eventIdx],n=Cu(t,this.levelWords,this.tierList),r={...e,word:t,distractors:n};this.activeEv=e.type===`blocks`?new Mu(this.scene,this.level,r):new Pu(this.scene,this.level,r),this.spoken=!1}speakIntro(){let e=this.activeEv.word;su(this.activeEv.type===`blocks`?`Bonk the block with the word: ${e}!`:`Jump through the door with the word: ${e}!`,{rate:.9}),this.repeatTimer=8,this.autoRepeats=0}onEventCorrect(e){let t=this.activeEv?this.activeEv.word:this.stars&&this.stars.word;this.results.push({word:t,firstTry:e}),sd(t,e),this.cb.onDot(this.results.length-1,e?`green`:`yellow`),this.bossFight&&this.bossFight.hit()}endIntro(){this.phase===`bossIntro`&&(this.phase=`run`,this.bossFight.settle())}startStars(){let e=this.results.filter(e=>!e.firstTry).map(e=>e.word),t=xu(this.results.map(e=>e.word)),n=e.slice(0,2);for(let e of t){if(n.length>=2)break;n.includes(e)||n.push(e)}let r=n.map(e=>({word:e,distractor:Cu(e,this.levelWords,this.tierList)[0]||`...`}));this.phase=`stars`,this.stars=new Iu(this.scene,this.level,{x:this.data.starX,reviews:r,onGem:()=>{this.runGems+=1,ud(1)},onDone:()=>{this.phase=`flagrun`}}),r.length&&(su(`Star time! Grab the star with the word: ${r[0].word}!`,{rate:.9}),this.repeatTimer=8,this.autoRepeats=0)}addCoins(e){this.runCoins=Math.max(0,this.runCoins+e),ld(e),this.cb.onCoins(this.runCoins)}bounceBack(e){Hl(),this.bounce={from:this.player.x,to:Math.max(2,e),t:0}}updateBounce(e){let t=this.bounce;t.t+=e/.45;let n=Math.min(1,t.t),r=1-(1-n)**3;this.player.x=t.from+(t.to-t.from)*r;let i=this.level.floorAt(this.player.x,this.player.y+1.5);this.player.y=i+Math.sin(n*Math.PI)*.9,this.player.group.position.set(this.player.x,this.player.y,0),n>=1&&(this.player.y=i,this.player.vy=0,this.player.grounded=!0,this.bounce=null)}updateCritters(e){let t=this.player;for(let n of this.critters){if(n.state===`off`)continue;if(n.state===`squash`){n.squashT-=e,n.g.scale.set(1.3,Math.max(.1,n.squashT/.4),1.3),n.squashT<=0&&(n.state=`off`,n.g.visible=!1);continue}let r=n.state===`flee`?2.6:1.1;if(n.x+=n.dir*r*e,n.state===`pace`)n.x<n.x0&&(n.x=n.x0,n.dir=1),n.x>n.x1&&(n.x=n.x1,n.dir=-1);else if(Math.abs(n.x-(n.x0+n.x1)/2)>14){n.state=`off`,n.g.visible=!1;continue}let i=this.level.groundTopAt(n.x);if(n.g.position.set(n.x,i+Math.abs(Math.sin(this.elapsed*8+n.x))*.08,0),n.g.rotation.y=n.dir>0?.25:-.25,n.g.rotation.z=Math.sin(this.elapsed*8+n.x)*.08,n.state!==`pace`||Math.abs(t.x-n.x)>.8)continue;let a=n.g.position.y;t.vy<-1&&t.y>a+.3&&t.y<a+1.1?(n.state=`squash`,n.squashT=.4,Vl(),this.effects.sparkle(n.g.position.clone()),this.effects.floatText(new U(n.x,a+1.4,0),`+2`),this.addCoins(2),t.bounce(7.5)):t.y<a+.8&&t.grounded&&(Fl(),t.stumble(),this.stumbleMul=.4,this.addCoins(-1),n.state=`flee`,n.dir=t.x<n.x?1:-1)}}updateKey(){if(!this.keyMesh.visible||this.keyFound)return;this.keyMesh.rotation.y+=.03,this.keyMesh.position.y=this.data.key.y+Math.sin(this.elapsed*2.5)*.15;let e=this.player;Math.abs(e.x-this.data.key.x)<.9&&e.y+1.7>this.data.key.y-.6&&e.y<this.data.key.y+.8&&(this.keyFound=!0,this.keyMesh.visible=!1,Wl(),this.effects.confetti(this.keyMesh.position.clone()),this.effects.sparkle(this.keyMesh.position.clone()),su(`You found a secret key!`,{rate:1}),this.cb.onKey(!0))}tick(e){this.elapsed+=e,this.running&&!this.paused&&this.updateRun(e),this.updateCamera(e)}updateRun(e){let t=this.player,n=this.choiceZone();this.choice&&!n?this.setChoice(!1):!this.choice&&n&&t.x>=n.engage&&(this.speed=0,zl(2),this.setChoice(!0));let r=Od;if(this.phase===`stars`&&(r=kd),(this.phase===`flag`||this.phase===`done`||this.choice)&&(r=0),(this.phase===`bossIntro`||this.phase===`bossDefeat`)&&(r=0),this.stumbleMul=Math.min(1,this.stumbleMul+e*1.2),r*=this.stumbleMul,this.speed+=(r-this.speed)*Math.min(1,e*4),this.bounce)this.updateBounce(e);else if(this.phase!==`flag`&&this.phase!==`done`){let r=this.choice?this.moveDir*Ad:this.speed;if(t.update(e,r,this.level,{onLand:e=>{e>6&&this.effects.sparkle(new U(t.x,t.y+.2,0))}}),this.choice&&n&&(t.x=Math.min(Math.max(t.x,n.min),n.max)),this.activeEv&&!this.activeEv.done){let e=this.activeEv.clampX();t.x>e&&(t.x=e)}}for(let e of this.level.collectCoins(t.x,t.y))Nl(),this.addCoins(1),this.effects.sparkle(e),this.effects.floatText(e,`+1`);if(this.choice||this.updateCritters(e),this.updateKey(),this.level.update(e,t.x),this.effects.update(e),this.bossFight){let n=this.activeEv&&!this.activeEv.done?this.activeEv:null;this.bossFight.update(e,t,this.api,{battle:this.phase===`run`,challengeActive:!!n,minX:n&&n.lastX?n.lastX+5:0})}if(this.phase===`bossIntro`)this.introT+=e,!this.introSpoke&&this.introT>1.4&&(this.introSpoke=!0,su(`The ${zu[this.worldIdx].name} wants to hear you read!`,{rate:1})),this.introT>5.5&&this.endIntro();else if(this.phase===`run`)this.activeEv?(!this.spoken&&t.x>this.activeEv.x-2&&(this.spoken=!0,this.speakIntro()),this.activeEv.update(e,t,this.api),this.activeEv.done&&t.x>this.activeEv.passedX()&&(this.activeEv.dispose(),this.activeEv=null,this.eventIdx++)):this.eventIdx<this.events.length?t.x>this.events[this.eventIdx].x-14&&this.spawnEvent():this.isBoss?(this.phase=`bossDefeat`,this.bossFight.startDefeat(this.api,t),su(`You did it! The ${zu[this.worldIdx].name} is amazed by your reading! Here comes your crown!`,{rate:1})):t.x>this.data.starX-10&&this.startStars();else if(this.phase===`stars`)this.stars.update(e,t,this.api);else if(this.phase===`bossDefeat`)this.bossFight.state===`gone`&&(this.phase=`flagrun`);else if(this.phase===`flagrun`)t.x>=this.data.flagX-.4&&(this.phase=`flag`,this.flagT=0,t.x=this.data.flagX-.45,Rl(),su(`Level complete! Amazing!`,{rate:1}),this.effects.fireworks(new U(t.x,3,0)));else if(this.phase===`flag`){this.flagT+=e;let n=this.level.groundTopAt(this.data.flagX),r=Math.min(1,this.flagT/1.1);t.y=Math.max(n,t.y-e*6),t.group.position.set(t.x,t.y,0),this.level.flag.position.y=7.4-r*6.2,r>=1&&(this.phase=`done`,this.doneTimer=2.4)}else this.phase===`done`&&(this.doneTimer-=e,this.doneTimer<=0&&this.finishRun());(this.stars&&!this.stars.done&&this.stars.reviews.length&&this.stars||this.activeEv&&!this.activeEv.done&&this.spoken&&this.activeEv)&&(this.repeatTimer-=e,this.repeatTimer<=0&&this.autoRepeats<2&&(this.autoRepeats++,this.repeatTimer=8,this.repeatWord()))}finishRun(){this.running=!1,this.clearEvents(),this.cb.onRunComplete({results:this.results,coins:this.runCoins,gems:this.runGems,keyFound:this.keyFound})}updateCamera(e){let t=this.player,n=1-Math.exp(-e*4),r=1-Math.exp(-e*3),i=t.x+3.2,a=Math.max(4.2,t.y*.6+3.4);this.camera.position.x+=(i-this.camera.position.x)*n,this.camera.position.y+=(a-this.camera.position.y)*r,this.camera.position.z=14,this.lookTarget.set(this.camera.position.x+.8,this.camera.position.y-1.6,0),this.camera.lookAt(this.lookTarget)}},Id=9,Ld=26;function Rd(){let e=fl(1234),t=[],n=[];yu.forEach((e,r)=>{let i=e.levels.length,a=r%2==0;for(let e=0;e<=i;e++){let n=e/i,o=a?n:1-n;t.push({world:r,level:e,boss:e===i,isWorldFinal:e===i,x:-26/2+o*Ld,z:r*Id+Math.sin(n*Math.PI*2+r)*1.4})}n.push({world:r,x:a?19:-26/2-6,z:r*Id-4.5})});let r=[null];for(let n=1;n<t.length;n++){let i=t[n-1],a=t[n],o=[{x:i.x,z:i.z}];if(i.world!==a.world){let e=i.x+(i.x>0?3.5:-3.5);o.push({x:e,z:i.z+Id*.5})}o.push({x:a.x,z:a.z}),r.push(Bd(o,e,i.world===a.world))}return{nodes:t,secretNodes:n,segments:r,bounds:{minX:-26/2-8,maxX:21,minZ:-5,maxZ:(yu.length-1)*Id+7}}}function zd(e,t){let n=t.x>=e.x?1:-1,r=t.z+.5;return Bd([{x:e.x,z:e.z},{x:e.x+n*.6,z:r+.7},{x:t.x-n*3.2,z:r},{x:t.x,z:t.z}],fl(99),!1)}function Bd(e,t,n){let r=[];for(let i=0;i<e.length-1;i++){let a=e[i],o=e[i+1],s=Math.hypot(o.x-a.x,o.z-a.z),c=Math.max(2,Math.round(s)),l=-(o.z-a.z)/(s||1),u=(o.x-a.x)/(s||1);for(let e=i===0?0:1;e<=c;e++){let i=e/c,s=n?Math.sin(i*Math.PI*2+t()*6)*.5:0;r.push({x:a.x+(o.x-a.x)*i+l*s,z:a.z+(o.z-a.z)*i+u*s})}}return r.slice(1,-1)}var Vd=new ji(1,1,1),Hd=new U(0,18,21),Ud=700,Wd=320,Gd=3e3,Kd=900,qd=80,Jd=.45,Yd=9,Xd=[16739201,16767293,16752627,7649791],Zd=.56;function Qd(e,t,n,r){return n?`${yu[e].name} Secret`:r?`${yu[e].name} Castle`:`${yu[e].name} ${t+1}`}var $d=class{constructor(e,t){this.cb=t,this.renderer=e,this.active=!1,this.scene=new _n,this.scene.background=new K(7980272),this.camera=new xa(45,window.innerWidth/window.innerHeight,.1,200);let n=new la(16777215,8956518,1.1),r=new wa(16773849,1.3);r.position.set(6,14,8),this.scene.add(n,r),this.effects=new Yu(this.scene),this.data=Rd(),this.buildCorridors(),this.buildWater(),this.buildTerrain(),this.buildProps(),this.buildSigns(),this.buildSkyClouds(),this.buildTiles(),this.buildNodes(),this.lockState=yu.map((e,t)=>({unlocked:Cd(t),t:1})),this.applyLockTints(),this.token=hu(.75),this.token.rotation.y=-Math.PI/2,this.scene.add(this.token),this.tokenNav=0,this.walk=null,this.focus=new U,this.panIdle=99,this.revealQueue=[],this.reveal=null,this.navList=[],this.attachInput()}buildCorridors(){let{nodes:e,secretNodes:t,segments:n}=this.data;this.keepCells=new Set,this.flatCells=new Set;let r=(e,t,n,r)=>{for(let i=Math.round(t-r);i<=Math.round(t+r);i++)for(let a=Math.round(n-r);a<=Math.round(n+r);a++)(i-t)**2+(a-n)**2<=r*r&&e.add(i+`,`+a)},i=(e,t,n,i)=>{let a=Math.max(1,Math.ceil(Math.hypot(n.x-t.x,n.z-t.z)*2));for(let o=0;o<=a;o++){let s=o/a;r(e,t.x+(n.x-t.x)*s,t.z+(n.z-t.z)*s,i)}};for(let t=1;t<e.length;t++){let n=e[t-1].world!==e[t].world;i(this.keepCells,e[t-1],e[t],n?1.3:2)}for(let e=1;e<n.length;e++)for(let t of n[e])r(this.keepCells,t.x,t.z,1.7);for(let e of this.keepCells)this.flatCells.add(e);t.forEach((t,n)=>{let a=e.filter(e=>e.world===n);i(this.flatCells,a[a.length-1],t,1.6);let o=e.find(e=>e.world===n+1);o&&i(this.flatCells,t,o,1.3);for(let e of a)if(e.level===1||(n+e.level)%2==0){let n={x:e.x,z:t.z+.5};i(this.flatCells,e,n,1.6),i(this.flatCells,n,t,1.6)}r(this.flatCells,t.x,t.z,2.2)})}buildWater(){let e=this.data.bounds,t=(e.minX+e.maxX)/2,n=(e.minZ+e.maxZ)/2,r=new q(Vd,new J({color:4161476}));r.scale.set(e.maxX-e.minX+60,1,e.maxZ-e.minZ+44),r.position.set(t,-1.35,n),this.scene.add(r);let i=[];for(let e=-14;e<=14;e++)for(let r=-9;r<=12;r++)e+r&1||i.push([t+e*3,n+r*3]);let a=new ui(Vd,new J({color:4952018}),i.length);a.frustumCulled=!1;let o=new sn;i.forEach(([e,t],n)=>{o.position.set(e,-.82,t),o.scale.set(3,.1,3),o.updateMatrix(),a.setMatrixAt(n,o.matrix)}),a.instanceMatrix.needsUpdate=!0,this.scene.add(a)}buildTerrain(){this.groundMesh=new ui(Vd,new J,Gd),this.groundMesh.frustumCulled=!1,this.scene.add(this.groundMesh),this.groundMeta=[],this.groundH=new Map;let e=new sn,t=new Set,n=(n,r,i,a,o)=>{let s=n+`,`+r;if(t.has(s)||this.groundMeta.length>=Gd)return;t.add(s),this.groundH.set(s,i);let c=1.3+i;e.position.set(n,i-c/2,r),e.scale.set(1,c,1),e.updateMatrix(),this.groundMesh.setMatrixAt(this.groundMeta.length,e.matrix);let l=new K(a);i>0&&l.offsetHSL(0,0,i*.035),this.groundMeta.push({region:o,color:l})};yu.forEach((e,t)=>{let r=dl[t],i=t*Yd,a=fl(t*53+11);for(let e=-21;e<=21;e++)for(let o=-5;o<=5;o++){let s=i+o,c=e+`,`+s,l=this.flatCells.has(c),u=Math.abs(e),d=Math.abs(o),f=u<=19&&d<=3;if(!f){let e=a();u<=20&&d<=3?f=e<.55:u===21&&d<=3?f=e<.15:u<=19&&d===4&&(f=e<.22)}if(this.keepCells.has(c)&&(f=!0),!f||t===4&&!l&&Math.sin(e*.9+2)*Math.sin(s*.8)<-.45)continue;let p=0;if(!l){let n=Math.sin(e*.55+t*2)+Math.sin(s*.75+e*.21);p=n>1.1?1:n>.35?.5:0}n(e,s,p,r.top[e+s&1],t)}let o=this.data.secretNodes[t],s=Math.round(o.x),c=Math.round(o.z);for(let e=-2;e<=2;e++)for(let i=-2;i<=2;i++)Math.abs(e)===2&&Math.abs(i)===2||n(s+e,c+i,0,r.top[e+i&1],t);if(t<yu.length-1){let e=t%2==0?1:-1;for(let r=12;r<=16;r++)for(let o=4;o<=5;o++)(r===12||r===16)&&a()<.4||n(e*r,i+o,0,r+o&1?15259292:14469518,t+1)}}),this.islands=[{x:-27,z:4,palm:!0},{x:27,z:13,palm:!1},{x:-26,z:22,palm:!1},{x:26,z:31,palm:!0}];let r=fl(4242);for(let e of this.islands)for(let t=-1;t<=1;t++)for(let i=-1;i<=1;i++)Math.abs(t)+Math.abs(i)===2&&r()<.5||n(e.x+t,e.z+i,0,t+i&1?15651982:15059326,-1);this.groundMesh.count=this.groundMeta.length,this.groundMesh.instanceMatrix.needsUpdate=!0}buildProps(){this.decorMesh=new ui(Vd,new J,Kd),this.decorMesh.frustumCulled=!1,this.scene.add(this.decorMesh),this.decorMeta=[],this.glowMesh=new ui(Vd,new J({emissive:2763349}),qd),this.glowMesh.frustumCulled=!1,this.scene.add(this.glowMesh),this.glowMeta=[];let e=new sn,t=(t,n,r)=>i=>(a,o,s,c,l,u,d,f=0,p=0)=>{n.length>=r||(e.position.set(a,o,s),e.scale.set(c,l,u),e.rotation.set(0,f,p),e.updateMatrix(),t.setMatrixAt(n.length,e.matrix),n.push({region:i,color:new K(d)}))},n=t(this.decorMesh,this.decorMeta,Kd),r=t(this.glowMesh,this.glowMeta,qd),i=(e,t,n,r,i,a)=>{e(t,n+.6,r,.35,1.2,.35,8015658),e(t,n+1.65,r,1.5,1.1,1.5,i),e(t,n+2.45,r,.9,.7,.9,a)},a=(e,t,n,r,i)=>{e(t,n+.22,r,.08,.45,.08,4169274),e(t,n+.5,r,.22,.22,.22,Xd[i&3])},o=(e,t,n,r)=>{e(t,n+.9,r,.28,1.8,.28,9263659),e(t,n+1.85,r,1.9,.22,.5,4169274,0,.5),e(t,n+1.85,r,1.9,.22,.5,5027141,0,-.6),e(t,n+2,r,.5,.22,1.9,4169274)},s=(e,t,n,r,i)=>{e(t,n+.3,r,1.1,.7,.9,i,.4),e(t+.4,n+.55,r+.2,.6,.5,.55,i,.9)},c=(e,t,n)=>{let r=[],i=0;for(;r.length<t&&i++<250;){let t=Math.round(-19+n()*38),i=Math.round(e*Yd-3+n()*6),a=t+`,`+i;!this.groundH.has(a)||this.flatCells.has(a)||r.some(e=>Math.abs(e.x-t)<2&&Math.abs(e.z-i)<2)||r.push({x:t,z:i,y:this.groundH.get(a)})}return r},l=[(e,t,n,r)=>{r<5?i(e,t.x,t.y,t.z,4169274,5027141):r===5?(e(t.x,t.y+.04,t.z,2.6,.1,1.9,5810152),e(t.x+1.5,t.y+.15,t.z+.8,.5,.3,.5,10263690)):a(e,t.x,t.y,t.z,r)},(e,t,n,r)=>{r<5?(e(t.x,t.y+.8,t.z,.45,1.6,.45,5088076),e(t.x+.5,t.y+1,t.z,.8,.3,.3,5088076),e(t.x+.75,t.y+1.35,t.z,.3,.6,.3,5088076)):r<10?(e(t.x,t.y+.25,t.z,2.6,.6,1.8,15916188,n()*.6),e(t.x+.8,t.y+.45,t.z+.3,1.4,.5,1.1,15257226)):r===10?o(e,t.x,t.y,t.z):s(e,t.x,t.y,t.z,13605730)},(e,t,n,r)=>{r<5?(e(t.x,t.y+.55,t.z,.32,1.1,.32,7031338),e(t.x,t.y+1.55,t.z,1.4,1,1.4,3046735),e(t.x,t.y+2.25,t.z,1.5,.4,1.5,16054524)):r===5?(e(t.x,t.y+.45,t.z,.9,.9,.9,16777215),e(t.x,t.y+1.2,t.z,.65,.65,.65,16054524),e(t.x,t.y+1.75,t.z,.45,.45,.45,16777215),e(t.x,t.y+1.75,t.z+.3,.1,.1,.25,16747586)):r<10?e(t.x,t.y+.03,t.z,1.9,.08,1.5,13625599,n()):s(e,t.x,t.y,t.z,11190998)},(e,t,n,r,i)=>{if(r<3)e(t.x-.9,t.y+.8,t.z,.6,1.6,.6,5526623),e(t.x+.9,t.y+.8,t.z,.6,1.6,.6,6184556),e(t.x,t.y+1.75,t.z,2.6,.55,.7,5526623);else if(r<9){let a=[8319231,13663999,16747224];for(let e=0;e<3;e++)i(t.x+(e-1)*.5,t.y+.7+n()*.4,t.z,.32,1.2+n()*.9,.32,a[(r+e)%3],0,(e-1)*.28);e(t.x,t.y+.12,t.z,1.5,.35,1.5,4868696)}else e(t.x,t.y+.25,t.z,.18,.5,.18,14209216),e(t.x,t.y+.58,t.z,.6,.28,.6,15684432)},(e,t,n,r)=>{r<4?i(e,t.x,t.y,t.z,4169274,9361518):a(e,t.x,t.y,t.z,r)}],u=[14,14,13,13,10];yu.forEach((e,t)=>{let i=fl(t*131+17),a=n(t),o=r(t);c(t,u[t],i).forEach((e,n)=>l[t](a,e,i,n,o))});{let e=n(4),t=4*Yd;[16732754,16750592,16767293,6942894,4244735,7964363,12216520].forEach((n,r)=>{let i=4.6-r*.32;for(let r=0;r<=10;r++){let a=r/10*Math.PI;e(-9+Math.cos(a)*i,.4+Math.sin(a)*i*.85,t-3.4,.34,.34,.3,n)}});let r=fl(777);for(let n=0;n<5;n++){let n=-16+r()*32,i=t-3+r()*6;e(n,-1.7,i,2.4+r()*1.5,.7,1.6+r(),16777215),e(n+1.2,-1.5,i+.4,1.5,.6,1.2,15923455)}}let d=n(-1);for(let e of this.islands)e.palm?o(d,e.x,0,e.z):s(d,e.x,0,e.z,10263690);let f=fl(31337);for(let e=0;e<42;e++){let e=-34+f()*68,t=-8+f()*56,n=.9+f()*.6,r=f()*.4-.2;this.groundH.has(Math.round(e)+`,`+Math.round(t))||d(e,-.72,t,n,.06,.16,15398655,r)}this.decorMesh.count=this.decorMeta.length,this.glowMesh.count=this.glowMeta.length,this.decorMesh.instanceMatrix.needsUpdate=!0,this.glowMesh.instanceMatrix.needsUpdate=!0}buildSigns(){let e=[`01110`,`10001`,`00001`,`00110`,`00100`,`00000`,`00100`];this.signMesh=new ui(Vd,new J({color:16769126,emissive:5915136}),100),this.signMesh.frustumCulled=!1,this.scene.add(this.signMesh),this.signMeta=[];let t=new sn;yu.forEach((n,r)=>{if(r===0)return;let i=.5;e.forEach((n,a)=>{for(let o=0;o<5;o++)n[o]===`1`&&(t.position.set((o-2)*i,2.6+(e.length-1-a)*i,r*Yd-2.2),t.scale.setScalar(i*.92),t.rotation.set(0,0,0),t.updateMatrix(),this.signMeta.push({region:r,matrix:t.matrix.clone()}))})}),this.signMesh.count=this.signMeta.length}buildSkyClouds(){this.mapClouds=[];let e=new J({color:16777215}),t=fl(909);for(let n=0;n<4;n++){let n=new cn;for(let r=0;r<3;r++){let i=new q(Vd,e);i.scale.set(1.8+t()*2,.8,1.5+t()),i.position.set(r*1.5-1.5,t()*.4,(t()-.5)*1.6),n.add(i)}n.position.set(-30+t()*60,9+t()*3,t()*38),n.userData.drift=.4+t()*.5,this.scene.add(n),this.mapClouds.push(n)}}buildTiles(){this.tileMesh=new ui(Vd,new J({color:16247216}),Ud),this.tileMesh.frustumCulled=!1,this.scene.add(this.tileMesh),this.tiles=[],this.segTiles=[null];for(let e=1;e<this.data.segments.length;e++){let t=this.data.segments[e];this.segTiles.push({start:this.tiles.length,count:t.length});for(let e of t)this.tiles.push({x:e.x,z:e.z,shown:!1,pop:0})}this.secretTileMesh=new ui(Vd,new J({color:13073904,emissive:2887493}),Wd),this.secretTileMesh.frustumCulled=!1,this.scene.add(this.secretTileMesh),this.secretTiles=[],this.secretSegs={}}ensureSecretTiles(e){if(this.secretSegs[e])return this.secretSegs[e];let t=vd(e),n=zd(this.data.nodes.find(n=>n.world===e&&n.level===(t===null?1:t))||this.data.nodes.find(t=>t.world===e),this.data.secretNodes[e]),r={start:this.secretTiles.length,count:n.length};for(let e of n)this.secretTiles.push({x:e.x,z:e.z,shown:!1,pop:0});return this.secretSegs[e]=r,r}buildNodes(){let e=()=>{let e=new cn,t=new J({color:16766282,emissive:6704384});for(let n=0;n<3;n++){let r=new q(Vd,t);r.scale.setScalar(.26);let i=(n-1)*.6;r.position.set(Math.sin(i)*1.15,.62,-Math.cos(i)*1.15),r.rotation.z=Math.PI/4,e.add(r)}return e},t=(t,n)=>{let r=new cn;r.position.set(t.x,0,t.z);let i=new q(Vd,new J({color:16774095}));i.scale.set(1.7,.25,1.7),i.position.y=.13;let a=new J({color:15022389}),o=new q(Vd,a);o.scale.set(1.15,.3,1.15),o.position.y=.4;let s=new q(Vd,new J({color:16773494,emissive:5587968}));s.scale.set(2.2,.12,2.2),s.position.y=.05,s.visible=!1;let c=e();r.add(i,o,s,c);let l=null;if(n){l=new cn;let e=new J({color:13073904,emissive:4856432}),t=new J({color:14922751,emissive:3609436});[[0,.9,0,.34,1.5,0],[-.42,.7,.18,.26,1,-.3],[.44,.65,-.12,.24,.9,.34],[.1,.5,.4,.18,.6,.12]].forEach(([n,r,i,a,o,s],c)=>{let u=new q(Vd,c%2?t:e);u.scale.set(a,o,a),u.position.set(n,r,i),u.rotation.set(0,c*.7,s),l.add(u)}),r.add(l)}let u=null,d=null,f=null;if(!n&&t.isWorldFinal){let e=new cn,n=new J({color:13220002}),i=new J({color:13915991}),a=new q(Vd,n);a.scale.set(1.7,1.2,1.5),a.position.y=.6;let o=new q(Vd,n);o.scale.set(1,.8,.9),o.position.y=1.5,e.add(a,o);for(let[t,r]of[[-.8,-.7],[.8,-.7],[-.8,.7],[.8,.7]]){let a=new q(Vd,n);a.scale.set(.45,1.9,.45),a.position.set(t,.95,r);let o=new q(Vd,i);o.scale.set(.6,.4,.6),o.position.set(t,2.05,r),e.add(a,o)}let s=new q(Vd,new J({color:14737632}));s.scale.set(.06,.9,.06),s.position.set(0,2.3,0),u=new q(Vd,new J({color:16766282})),u.scale.set(.5,.3,.05),u.position.set(.28,2.55,0);let c=new J({color:16766282,emissive:6704384});d=new cn;let l=new q(Vd,c);l.scale.set(.6,.22,.6),d.add(l);for(let e of[-.2,0,.2]){let t=new q(Vd,c);t.scale.set(.13,.24,.13),t.position.set(e,.22,0),d.add(t)}d.position.set(0,2,0),f=new cn;let p=new q(Vd,new J({color:zu[t.world].color}));p.scale.set(.95,.8,.85),f.add(p);let m=new J({color:16777215}),h=new J({color:2236962});for(let e of[-.22,.22]){let t=new q(Vd,m);t.scale.setScalar(.22),t.position.set(e,.08,.44);let n=new q(Vd,h);n.scale.setScalar(.1),n.position.set(e,.06,.55),f.add(t,n)}let g=new q(Vd,h);g.scale.set(.32,.08,.06),g.position.set(0,-.22,.44),f.add(g),f.position.set(0,3.3,0),e.add(s,u,d,f),e.position.set(0,0,-1.7),r.add(e)}let p=new q(Vd,new Vr({visible:!1}));return p.scale.set(3,3,3),p.position.y=1,r.add(p),this.scene.add(r),{group:r,dot:o,dotMat:a,ring:s,stars:c,crystals:l,hit:p,castleFlag:u,crown:d,bossHead:f,baseY:0}};this.nodeViews=this.data.nodes.map(e=>t(e,!1)),this.secretViews=this.data.secretNodes.map(e=>t(e,!0))}refreshLocks(){yu.forEach((e,t)=>{let n=this.lockState[t],r=Cd(t);if(r&&!n.unlocked){n.unlocked=!0,n.t=0;let e=new U(0,1.5,t*Yd);this.effects.confetti(e),this.effects.sparkle(e)}else!r&&n.unlocked&&(n.unlocked=!1,n.t=1)}),this.applyLockTints()}lockFactor(e){if(e<0)return 1;let t=this.lockState[e];return t.unlocked?Jd+(1-Jd)*Math.min(1,t.t):Jd}applyLockTints(){let e=new K,t=(t,n)=>{for(let r=0;r<n.length;r++)e.copy(n[r].color).multiplyScalar(this.lockFactor(n[r].region)),t.setColorAt(r,e);t.instanceColor&&(t.instanceColor.needsUpdate=!0)};t(this.groundMesh,this.groundMeta),t(this.decorMesh,this.decorMeta),t(this.glowMesh,this.glowMeta);let n=new Nt().makeScale(1e-4,1e-4,1e-4);this.signMeta.forEach((e,t)=>{this.signMesh.setMatrixAt(t,this.lockState[e.region].unlocked?n:e.matrix)}),this.signMesh.instanceMatrix.needsUpdate=!0}heightAt(e,t){return this.groundH.get(Math.round(e)+`,`+Math.round(t))||0}refresh(){let e=id().unlocked;this.navList=[],this.data.nodes.forEach((t,n)=>{let r=this.nodeViews[n],i=Sd(t.world,t.level);r.group.visible=i;let a=dd(t.world,t.level),o=t.world===e.world&&t.level===e.level;if(r.dotMat.color.setHex(a>0?4431943:15022389),r.dotMat.emissive.setHex(o?6693410:0),r.ring.visible=o,r.isCurrent=o,r.stars.children.forEach((e,t)=>{e.visible=t<a}),t.boss&&r.bossHead){let e=yd(t.world);r.bossHead.visible=!e,r.castleFlag.visible=e,r.crown.visible=e}if(hd(t.world,t.level)&&!r.keyIcon&&(r.keyIcon=Pd(),r.keyIcon.scale.setScalar(.36),r.keyIcon.position.set(1.25,1,.35),r.group.add(r.keyIcon)),n>0){let e=i,t=this.segTiles[n];for(let n=0;n<t.count;n++)this.tiles[t.start+n].shown=e}if(i&&this.navList.push({world:t.world,level:t.level,secret:!1,boss:!!t.boss,x:t.x,z:t.z,i:n}),i&&t.isWorldFinal&&_d(t.world)){let e=this.data.secretNodes[t.world];this.navList.push({world:t.world,level:-1,secret:!0,x:e.x,z:e.z,i:-1})}}),this.data.secretNodes.forEach((e,t)=>{let n=this.secretViews[t],r=_d(t);n.group.visible=r,n.dotMat.color.setHex(11225020),n.dotMat.emissive.setHex(2887493);let i=pd(t);if(n.stars.children.forEach((e,t)=>{e.visible=t<i}),r){let n=this.ensureSecretTiles(t);for(let e=0;e<n.count;e++)this.secretTiles[n.start+e].shown=!0;if(!this.navList.some(e=>e.secret&&e.world===t)){let n=this.navList.map(e=>e.world).lastIndexOf(t);this.navList.splice(n+1,0,{world:t,level:-1,secret:!0,x:e.x,z:e.z,i:-1})}}}),this.tokenNav=Math.min(this.tokenNav,this.navList.length-1),this.refreshLocks(),this.updateTiles()}updateTiles(){let e=new sn,t=(t,n)=>{n.forEach((n,r)=>{let i=n.shown?n.pop>0?1+Math.sin(n.pop*Math.PI)*.4:1:1e-4;e.position.set(n.x,n.shown&&n.pop>0?.1+n.pop*.3:.08,n.z),e.scale.set(.72*i,.16,.72*i),e.updateMatrix(),t.setMatrixAt(r,e.matrix)}),t.count=n.length,t.instanceMatrix.needsUpdate=!0};t(this.tileMesh,this.tiles),t(this.secretTileMesh,this.secretTiles)}navInfo(e){return{world:e.world,level:e.level,secret:e.secret,boss:!!e.boss,name:Qd(e.world,e.level,e.secret,e.boss),stars:e.secret?pd(e.world):dd(e.world,e.level),completed:(e.secret?pd(e.world):dd(e.world,e.level))>0}}currentNav(){return this.navList[this.tokenNav]}setTokenTo(e,t,n=!1){let r=this.navList.findIndex(r=>r.world===e&&(n?r.secret:r.level===t&&!r.secret));r>=0&&(this.tokenNav=r);let i=this.navList[this.tokenNav];i&&this.token.position.set(i.x,Zd,i.z),this.token.rotation.y=-Math.PI/2}attachInput(){let e=this.renderer.domElement;this.raycaster=new Ha;let t=null,n=!1,r=e=>{this.active&&(e.target&&e.target.closest&&e.target.closest(`button`)||(t={x:e.clientX,y:e.clientY},n=!1))},i=e=>{if(!this.active||!t)return;let r=e.clientX-t.x,i=e.clientY-t.y;if(!n&&Math.hypot(r,i)>10&&(n=!0),n){let n=.028,a=this.data.bounds;this.focus.x=Math.max(a.minX,Math.min(a.maxX,this.focus.x-r*n)),this.focus.z=Math.max(a.minZ,Math.min(a.maxZ,this.focus.z-i*n)),t={x:e.clientX,y:e.clientY},this.panIdle=0}},a=e=>{if(!this.active||!t)return;let r=n;t=null,n=!1,!r&&this.tap(e.clientX,e.clientY)};window.PointerEvent?(e.addEventListener(`pointerdown`,r),window.addEventListener(`pointermove`,i),window.addEventListener(`pointerup`,a)):(e.addEventListener(`mousedown`,r),window.addEventListener(`mousemove`,i),window.addEventListener(`mouseup`,a),e.addEventListener(`touchstart`,e=>r(e.changedTouches[0]),{passive:!0}),window.addEventListener(`touchmove`,e=>i(e.changedTouches[0]),{passive:!0}),window.addEventListener(`touchend`,e=>a(e.changedTouches[0]))),window.addEventListener(`keydown`,e=>{if(this.active)if(e.code===`ArrowLeft`||e.code===`ArrowRight`){e.preventDefault();let t=e.code===`ArrowLeft`?-1:1,n=this.tokenNav+t;n>=0&&n<this.navList.length&&!this.walk&&!this.reveal&&this.walkTo(n)}else e.code===`Enter`&&(e.preventDefault(),this.cb.onEnterKey())})}tap(e,t){if(this.reveal)return;let n=new H(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1);this.raycaster.setFromCamera(n,this.camera);let r=[];this.navList.forEach((e,t)=>{let n=e.secret?this.secretViews[e.world]:this.nodeViews[e.i],i=this.raycaster.intersectObject(n.hit,!1);i.length&&r.push({idx:t,dist:i[0].distance})}),r.length?(r.sort((e,t)=>e.dist-t.dist),this.walkTo(r[0].idx)):this.cb.onDismiss()}walkTo(e){if(e===this.tokenNav){this.cb.onNodeSelected(this.navInfo(this.navList[e]));return}this.cb.onDismiss();let t=e>this.tokenNav?1:-1,n=[];for(let r=this.tokenNav;r!==e;r+=t){let e=this.navList[r],i=this.navList[r+t];for(let t=1;t<=8;t++){let r=t/8;n.push({x:e.x+(i.x-e.x)*r,z:e.z+(i.z-e.z)*r})}}let r=0;for(let e=1;e<n.length;e++)r+=Math.hypot(n[e].x-n[e-1].x,n[e].z-n[e-1].z);this.walk={points:n,t:0,dur:Math.min(2,.3+r*.09),target:e},this.panIdle=99}queueReveal(e){this.revealQueue.push(e)}startReveal(e){let t,n,r;if(e.kind===`secret`)t=this.ensureSecretTiles(e.world),r=this.secretTiles,n=this.secretViews[e.world];else{let i=this.data.nodes.findIndex(t=>t.world===e.world&&t.level===e.level);if(i<=0)return;t=this.segTiles[i],r=this.tiles,n=this.nodeViews[i]}for(let e=0;e<t.count;e++)r[t.start+e].shown=!1,r[t.start+e].pop=0;n.group.visible=!1,this.reveal={seg:t,tiles:r,view:n,k:0,timer:.35,tileDelay:Math.min(.11,1.5/Math.max(1,t.count)),nodeT:-1,secret:e.kind===`secret`}}updateReveal(e){let t=this.reveal;for(let n=0;n<t.seg.count;n++){let r=t.tiles[t.seg.start+n];r.pop>0&&(r.pop=Math.max(0,r.pop-e*3))}if(t.nodeT>=0){t.nodeT+=e;let n=Math.min(1,t.nodeT/.55),r=6*(1-n)*(1-n)-Math.sin(n*Math.PI)*0;t.view.group.position.y=r,n>=1&&!t.landed&&(t.landed=!0,t.view.group.position.y=0,Hl(),this.effects.confetti(new U(t.view.group.position.x,1.5,t.view.group.position.z)),t.secret&&(this.effects.sparkle(new U(t.view.group.position.x,1.5,t.view.group.position.z)),su(`A secret path appeared!`,{rate:1}))),t.nodeT>1.3&&(this.reveal=null,this.refresh()),this.updateTiles();return}if(t.timer-=e,t.timer<=0)if(t.k<t.seg.count){let e=t.tiles[t.seg.start+t.k];e.shown=!0,e.pop=1,zl(t.k),this.focus.x+=(e.x-this.focus.x)*.35,this.focus.z+=(e.z-this.focus.z)*.35,this.panIdle=0,t.k++,t.timer=t.tileDelay}else t.nodeT=0,t.view.group.visible=!0,t.view.group.position.y=6;this.updateTiles()}enter(){this.active=!0,this.refresh(),this.revealQueue.length&&!this.reveal&&(this.startReveal(this.revealQueue.shift()),this.updateTiles());let e=this.currentNav();e&&this.token.position.set(e.x,Zd,e.z),this.focus.set(this.token.position.x,0,this.token.position.z),this.camera.position.copy(this.focus).add(Hd),this.camera.lookAt(this.focus),this.panIdle=99}exit(){this.active=!1}animateStars(e,t){let n=this.token.position.x-e.group.position.x,r=this.token.position.z-e.group.position.z;e.stars.visible=n*n+r*r>1.2,e.stars.children.forEach((e,n)=>{e.rotation.y=t*1.6+n*2.1,e.position.y=.62+Math.sin(t*2.4+n*2.1)*.07})}tick(e){let t=performance.now()/1e3,n=!1;this.lockState.forEach((t,r)=>{t.unlocked&&t.t<1&&(t.t=Math.min(1,t.t+e),n=!0,Math.random()<e*8&&this.effects.sparkle(new U(-16+Math.random()*32,1.6,r*Yd-3+Math.random()*6)))}),n&&this.applyLockTints();let r=this.data.bounds;for(let t of this.mapClouds)t.position.x+=t.userData.drift*e,t.position.x>r.maxX+26&&(t.position.x=r.minX-26);if(this.nodeViews.forEach((e,n)=>{if(!e.group.visible)return;let r=1.15+Math.sin(t*3+e.group.position.x)*.09,i=e.isCurrent?1.15+Math.sin(t*5)*.14:r;if(e.dot.scale.set(i,.3,i),e.isCurrent){let n=2.2+Math.sin(t*3)*.3;e.ring.scale.set(n,.12,n),e.dot.position.y=.4+Math.max(0,Math.sin(t*3))*.16}else e.dot.position.y=.4;this.animateStars(e,t),e.keyIcon&&(e.keyIcon.rotation.y=t*1.4,e.keyIcon.position.y=1+Math.sin(t*2+n)*.08),e.bossHead&&e.bossHead.visible&&(e.bossHead.rotation.y=Math.sin(t*1.3+n)*.5,e.bossHead.position.y=3.3+Math.sin(t*2.1+n)*.12)}),this.secretViews.forEach((n,r)=>{if(!n.group.visible)return;let i=1.15+Math.sin(t*4+r)*.12;n.dot.scale.set(i,.3,i),n.crystals&&(n.crystals.rotation.y=t*.4),this.animateStars(n,t),Math.random()<e*.8&&this.effects.sparkle(new U(n.group.position.x+(Math.random()-.5),1.2,n.group.position.z))}),!this.reveal&&this.revealQueue.length&&!this.walk&&this.startReveal(this.revealQueue.shift()),this.reveal&&this.updateReveal(e),this.walk){let t=this.walk;t.t+=e/t.dur;let n=Math.min(t.points.length-1,Math.floor(t.t*t.points.length)),r=t.points[n],i=this.token.position;this.token.rotation.y=Math.atan2(i.z-r.z,r.x-i.x);let a=this.heightAt(r.x,r.z);this.token.position.set(r.x,Zd+a+Math.abs(Math.sin(t.t*22))*.18,r.z);let o=this.token.userData.parts,s=Math.sin(t.t*30);if(o.legL.rotation.z=-s*.8,o.legR.rotation.z=s*.8,o.armL.rotation.z=s*.8,o.armR.rotation.z=-s*.8,t.t>=1){this.tokenNav=t.target;let e=this.navList[t.target];this.token.position.set(e.x,Zd,e.z),this.token.rotation.y=-Math.PI/2,o.legL.rotation.z=o.legR.rotation.z=0,o.armL.rotation.z=o.armR.rotation.z=0,this.walk=null,this.cb.onNodeSelected(this.navInfo(e))}}else this.reveal||(this.token.position.y=Zd+Math.abs(Math.sin(t*2))*.05);if(this.panIdle+=e,this.panIdle>4||this.walk){let t=1-Math.exp(-e*3);this.focus.x+=(this.token.position.x-this.focus.x)*t,this.focus.z+=(this.token.position.z-this.focus.z)*t}this.camera.position.set(this.focus.x+Hd.x,Hd.y,this.focus.z+Hd.z),this.camera.lookAt(this.focus.x,0,this.focus.z),this.effects.update(e)}},Q=e=>document.getElementById(e),ef=[`title`,`map`,`pause`,`complete`,`bonus`];function tf(e){nf(Q(`btn-play`),`Play!`,()=>e.onPlay()),nf(Q(`btn-settings`),`Settings`,()=>Q(`settings-panel`).classList.toggle(`hidden`)),nf(Q(`btn-settings-close`),`Close`,()=>Q(`settings-panel`).classList.add(`hidden`)),nf(Q(`btn-toggle-sound`),`Sound`,()=>e.onToggleSound()),nf(Q(`btn-toggle-mic`),`Mic round`,()=>e.onToggleMic()),nf(Q(`btn-map-back`),`Back`,()=>e.onMapBack()),nf(Q(`btn-banner-play`),`Here we go!`,()=>e.onBannerPlay()),nf(Q(`btn-pause`),`Pause`,()=>e.onPause()),nf(Q(`btn-resume`),`Resume`,()=>e.onResume()),nf(Q(`btn-pause-map`),`Map`,()=>e.onPauseMap()),Q(`btn-repeat-word`).addEventListener(`click`,()=>e.onRepeatWord()),nf(Q(`btn-play-again`),`Play again!`,()=>e.onPlayAgain()),nf(Q(`btn-next-level`),`Next level!`,()=>e.onNextLevel()),nf(Q(`btn-complete-map`),`Map`,()=>e.onCompleteMap()),nf(Q(`btn-bonus-skip`),`Skip`,()=>e.onBonusSkip()),rf(Q(`btn-mic`),e.onMicDown,e.onMicUp),rf(Q(`btn-move-left`),()=>e.onMoveDown(-1),()=>e.onMoveUp(-1)),rf(Q(`btn-move-right`),()=>e.onMoveDown(1),()=>e.onMoveUp(1)),rf(Q(`btn-move-jump`),e.onJumpDown,e.onJumpUp);let t=0;Q(`version-tag`).addEventListener(`click`,()=>{t++,t>=5&&(t=0,e.onDevUnlock())})}function nf(e,t,n){e.addEventListener(`click`,()=>{su(t,{rate:1}),n()})}function rf(e,t,n){let r=e=>{e.preventDefault(),t()},i=e=>{e.preventDefault(),n()};e.addEventListener(`touchstart`,r,{passive:!1}),e.addEventListener(`touchend`,i,{passive:!1}),e.addEventListener(`touchcancel`,i,{passive:!1}),e.addEventListener(`mousedown`,r),e.addEventListener(`mouseup`,i),e.addEventListener(`mouseleave`,i)}function af(e){for(let t of ef)Q(`screen-${t}`).classList.toggle(`hidden`,t!==e);e!==`map`&&lf()}function of(e){Q(`hud`).classList.toggle(`hidden`,!e)}function sf(){let e=id();Q(`btn-toggle-sound`).textContent=e.sound?`🔊 Sound: ON`:`🔇 Sound: OFF`,Q(`btn-toggle-mic`).textContent=e.mic?`🎤 Mic Round: ON`:`🎤 Mic Round: OFF`}function cf({name:e,stars:t,completed:n,secret:r,boss:i}){Q(`banner-name`).textContent=r?`✨ ${e} ✨`:i?`👑 ${e} 👑`:e,Q(`banner-stars`).textContent=t>0?`⭐`.repeat(t):`· · ·`,Q(`btn-banner-play`).textContent=n?`🔁 PLAY`:`▶️ PLAY`,Q(`level-banner`).classList.remove(`hidden`)}function lf(){Q(`level-banner`).classList.add(`hidden`)}function uf(){return!Q(`level-banner`).classList.contains(`hidden`)}function df(e){Q(`coin-count`).textContent=e}function ff(e){Q(`hud-key`).classList.toggle(`hidden`,!e)}function pf(e){Q(`move-controls`).classList.toggle(`hidden`,!e)}function mf(e){let t=Q(`progress-dots`);t.innerHTML=``;for(let n=0;n<e;n++){let e=document.createElement(`div`);e.className=`dot`,t.appendChild(e)}}function hf(e,t){let n=Q(`progress-dots`).children[e];n&&(n.className=`dot ${t}`)}function gf({stars:e,coins:t,gems:n,hasNext:r}){af(`complete`),Q(`complete-coins`).textContent=t,Q(`complete-gems`).textContent=n,Q(`btn-next-level`).classList.toggle(`hidden`,!r);let i=Q(`star-row`).querySelectorAll(`.star`);i.forEach(e=>e.classList.remove(`earned`));for(let t=0;t<e;t++)setTimeout(()=>i[t].classList.add(`earned`),500+t*450)}function _f(e){Q(`bonus-word`).textContent=e,Q(`bonus-feedback`).textContent=``}function vf(e){Q(`bonus-feedback`).textContent=e}function yf(e){Q(`btn-mic`).classList.toggle(`listening`,e)}var bf=window.webkitSpeechRecognition||window.SpeechRecognition||null,xf=null,Sf=!1;function Cf(){return!!bf}function wf(e,t){if(!bf||Sf)return!1;try{return xf=new bf,xf.lang=`en-US`,xf.interimResults=!0,xf.maxAlternatives=5,xf.continuous=!1,xf.onresult=t=>{let n=[];for(let e=0;e<t.results.length;e++){let r=t.results[e];for(let e=0;e<r.length;e++){let t=(r[e].transcript||``).toLowerCase().replace(/[^a-z'\s]/g,``);for(let e of t.split(/\s+/))e&&n.push(e)}}n.length&&e&&e(n)},xf.onerror=()=>Tf(t),xf.onend=()=>Tf(t),xf.start(),Sf=!0,!0}catch{return Tf(t),!1}}function Tf(e){Sf&&(Sf=!1,xf=null,e&&e())}function Ef(){if(xf)try{xf.stop()}catch{}Sf=!1}var Df=new URLSearchParams(location.search);Df.has(`reset`)&&wd(),nd(),Df.has(`unlock`)&&Td(yu.length),kl(!id().sound);var Of=yu.map(e=>e.levels.length),kf={world:0,level:0,secret:!1},Af=null,jf=null,$=null,Mf=`map`,Nf=()=>Ol();window.addEventListener(`pointerdown`,Nf,{once:!0}),window.addEventListener(`touchstart`,Nf,{once:!0});var Pf=document.getElementById(`game-container`),Ff=new ul({antialias:!0});Ff.setPixelRatio(Math.min(window.devicePixelRatio,2)),Ff.setSize(window.innerWidth,window.innerHeight),Ff.outputColorSpace=ze,Pf.appendChild(Ff.domElement);var If=new Fd(Ff,{onCoins:e=>df(e),onDotsInit:e=>mf(e),onDot:(e,t)=>hf(e,t),onKey:e=>ff(e),onChoice:e=>pf(e),onRunComplete:e=>Gf(e)}),Lf=new $d(Ff,{onNodeSelected:e=>{Af=e,su(e.name,{rate:1}),cf(e)},onDismiss:()=>{Af=null,lf()},onEnterKey:()=>{Af&&uf()?Hf():Lf.walkTo(Lf.tokenNav)}});window.__wr={game:If,store:Qu,map:Lf};var Rf=new Ga;Ff.setAnimationLoop(()=>{let e=Math.min(Rf.getDelta(),.05);Mf===`game`?(If.tick(e),Ff.render(If.scene,If.camera)):(Lf.tick(e),Ff.render(Lf.scene,Lf.camera))});function zf(){for(let e of[If.camera,Lf.camera])e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix();Ff.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,zf),window.addEventListener(`orientationchange`,zf);function Bf(){Mf=`map`,Lf.enter(),of(!1),af(`map`)}function Vf(e,t,n=!1){let r=!n&&t===Of[e];kf={world:e,level:t,secret:n,boss:r},Lf.exit(),Mf=`game`,If.startRun(e,t,{secret:n,boss:r}),af(null),of(!0)}function Hf(){if(!Af)return;let e=Af;Af=null,lf(),Vf(e.world,e.secret?0:e.level,e.secret)}function Uf(e,t){return t+1<=Of[e]?{world:e,level:t+1}:e+1<yu.length?{world:e+1,level:0}:null}function Wf(e){let t=e.length||1,n=e.filter(e=>e.firstTry).length;return n===t?3:n/t>=.7?2:1}function Gf(e){jf=e,of(!1);let t=Wf(e.results);if(jf.stars=t,kf.secret)md(kf.world,t);else{let n=dd(kf.world,kf.level)===0;if(fd(kf.world,kf.level,t),xd(kf.world,kf.level,Of),kf.boss&&bd(kf.world),n){let e=Uf(kf.world,kf.level);e&&Sd(e.world,e.level)&&Lf.queueReveal({kind:`node`,world:e.world,level:e.level})}e.keyFound&&!hd(kf.world,kf.level)&&(gd(kf.world,kf.level),Lf.queueReveal({kind:`secret`,world:kf.world}))}Cf()&&id().mic&&e.results.length?Jf(e):Kf()}function Kf(){let e=kf.secret?null:Uf(kf.world,kf.level);gf({stars:jf.stars,coins:jf.coins,gems:jf.gems,hasNext:!!e&&Sd(e.world,e.level)})}function qf(){Bf(),Lf.setTokenTo(kf.world,kf.level,kf.secret)}function Jf(e){try{$={words:xu(e.results.map(e=>e.word)).slice(0,3),idx:0,matched:!1,heard:[],advancing:!1},af(`bonus`),su(`Bonus round! Read the word out loud. Hold the microphone and say it!`,{rate:1}),Yf()}catch{Zf()}}function Yf(){$.matched=!1,$.heard=[],$.advancing=!1,_f($.words[$.idx])}function Xf(){!$||$.advancing||($.advancing=!0,Ef(),yf(!1),setTimeout(()=>{$&&($.idx++,$.idx>=$.words.length?Zf():Yf())},1400))}function Zf(){$=null,Ef(),yf(!1),Kf()}function Qf(e){return(e||``).toLowerCase().replace(/[^a-z']/g,``)}function $f(){if(!$||$.advancing)return;let e=Qf($.words[$.idx]);wf(t=>{!$||$.matched||($.heard.push(...t),t.some(t=>Qf(t)===e)&&($.matched=!0,$.heard=[],jf.gems+=5,ud(5),Pl(),vf(`⭐ +5 💎`),su(Eu[Math.random()*Eu.length|0],{rate:1}),Xf()))},()=>{yf(!1),!(!$||$.matched||$.advancing)&&$.heard.length&&(vf(`💛 Nice try!`),su(`Nice try! The word is: ${$.words[$.idx]}`,{rate:.9}),Xf())})&&yf(!0)}function ep(){Ef(),yf(!1)}tf({onPlay:()=>Bf(),onToggleSound:()=>{let e=!id().sound;Ed(e),kl(!e),sf(),e&&Nl()},onToggleMic:()=>{Dd(!id().mic),sf()},onMapBack:()=>{Lf.exit(),af(`title`)},onBannerPlay:()=>Hf(),onPause:()=>{If.pause(),af(`pause`)},onResume:()=>{af(null),If.resume()},onPauseMap:()=>{If.stopRun(),Bf()},onRepeatWord:()=>If.repeatWord(),onPlayAgain:()=>Vf(kf.world,kf.level,kf.secret),onNextLevel:()=>{let e=Uf(kf.world,kf.level);e&&Vf(e.world,e.level)},onCompleteMap:()=>qf(),onBonusSkip:()=>{$&&($.advancing=!0,Ef(),$.idx=$.words.length,Zf())},onMicDown:$f,onMicUp:ep,onMoveDown:e=>If.setMove(`btn`,e,!0),onMoveUp:e=>If.setMove(`btn`,e,!1),onJumpDown:()=>If.running&&!If.paused&&If.player.jump(),onJumpUp:()=>{},onDevUnlock:()=>{Td(yu.length),su(`All levels unlocked!`,{rate:1}),Lf.refresh()}}),sf(),af(`title`),Lf.enter(),Lf.exit(),document.addEventListener(`visibilitychange`,()=>{document.hidden&&If.running&&!If.paused&&(If.pause(),af(`pause`))});