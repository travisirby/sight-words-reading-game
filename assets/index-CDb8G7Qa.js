...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(e,t,n){let r=new Float32Array(mo),i=new V(0,1,0);return new qi({name:`SphericalGaussianBlur`,defines:{n:mo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:jo(),fragmentShader:`
	...
	`}var Mo=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var rc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ic(e,t){let n=rc[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ac=new V;function oc(){return bt.getLuminanceCoefficients(ac),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ac.x.toFixed(4)}, ${ac.y.toFixed(4)}, ${ac.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    </div>`,document.body.appendChild(sp);let e=new gl({alpha:!0,antialias:!0});e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setSize(96,96),e.outputColorSpace=Ve,sp.querySelector(`.fairy-bob`).prepend(e.domElement);let t=new yn,n=new Ea(38,1,.1,20);n.position.set(0,.15,3.4),n.lookAt(0,0,0),t.add(new Aa(16777215,.85));let r=new ka(16777215,1.6);r.position.set(2,4,5),t.add(r);let i=op();t.add(i.group);let a=0,o=!1;e.setAnimationLoop(()=>{let r=1/60;a+=r;let s=Math.sin(a*(lp?38:11))*.3+.25;i.wingL.rotation.y=-s,i.wingR.rotation.y=s,i.group.rotation.y=-.3+Math.sin(a*.7)*.18,i.star.rotation.z+=r*(lp?9:1.2);let c=lp&&Math.sin(a*16)>0;c!==o&&(o=c,i.face.map=c?i.faceOpen:i.faceClosed,i.face.needsUpdate=!0),i.legL.rotation.x=Math.sin(a*2.1)*.18,i.legR.rotation.x=Math.sin(a*2.1+1.4)*.18,e.render(t,n)}),window.addEventListener(`wr-speech`,e=>{lp=!!e.detail.speaking,sp.classList.toggle(`speaking`,lp)})}function dp(e){if(!sp)return;let t=Zf[e];t&&(t.x!==cp&&sp.classList.toggle(`face-left`,t.x<cp),cp=t.x,sp.style.left=`${t.x}%`,sp.style.top=`${t.y}%`)}var fp=[{id:`rug`,name:`Cozy Rug`,emoji:`🟥`,cost:25,currency:`coins`},{id:`chair`,name:`Comfy Chair`,emoji:`🪑`,cost:35,currency:`coins`},{id:`table`,name:`Table`,emoji:`🍽️`,cost:45,currency:`coins`},{id:`bed`,name:`Big Kid Bed`,emoji:`🛏️`,cost:60,currency:`coins`},{id:`lamp`,name:`Lamp`,emoji:`💡`,cost:50,currency:`coins`},{id:`bookshelf`,name:`Bookshelf`,emoji:`📚`,cost:80,currency:`coins`},{id:`toybox`,name:`Toy Box`,emoji:`🧸`,cost:90,currency:`coins`},{id:`flowers`,name:`Flower Bed`,emoji:`🌷`,cost:40,currency:`coins`},{id:`mailbox`,name:`Mailbox`,emoji:`📬`,cost:55,currency:`coins`},{id:`tree`,name:`Shady Tree`,emoji:`🌳`,cost:75,currency:`coins`},{id:`swing`,name:`Swing Set`,emoji:`🛝`,cost:120,currency:`coins`},{id:`trampoline`,name:`Trampoline`,emoji:`🤸`,cost:150,currency:`coins`},{id:`cat`,name:`Pet Cat`,emoji:`🐱`,cost:20,currency:`gems`},{id:`dog`,name:`Pet Dog`,emoji:`🐶`,cost:30,currency:`gems`},{id:`aquarium`,name:`Fish Tank`,emoji:`🐠`,cost:40,currency:`gems`},{id:`telescope`,name:`Telescope`,emoji:`🔭`,cost:55,currency:`gems`},{id:`robot`,name:`Robot Buddy`,emoji:`🤖`,cost:70,currency:`gems`},{id:`rocket`,name:`Rocket Ship`,emoji:`🚀`,cost:100,currency:`gems`}],pp=200;function mp(e){let t=new gl({antialias:!0,alpha:!0,preserveDrawingBuffer:!0});t.setSize(pp,pp),t.outputColorSpace=Ve;let n=new yn;n.add(new Aa(16777215,.8));let r=new ka(16777215,.9);r.position.set(2,4,3),n.add(r);let i=new Ea(35,1,.1,20);i.position.set(0,1.35,3.4),i.lookAt(0,.8,0);let a=Ed(1);a.rotation.y=-Math.PI/2+.45,n.add(a);let o=e.map(e=>(Td(a,e),t.render(n,i),t.domElement.toDataURL(`image/png`))),s=a.userData.parts;s.face.map&&s.face.map.dispose();for(let e of[...s.mats,s.face])e.dispose();return a.traverse(e=>e.geometry&&e.geometry.dispose()),t.dispose(),t.forceContextLoss(),o}var $=e=>document.getElementById(e),hp=[`title`,`players`,`map`,`pause`,`complete`,`bonus`,`char`,`house`];function gp(e){up(),_p($(`btn-play`),`Play!`,()=>e.onPlay()),_p($(`btn-character`),`Make your character!`,()=>e.onCharacter()),_p($(`btn-char-back`),`Back`,()=>e.onCharacterDone()),_p($(`btn-char-done`),`Looking good!`,()=>e.onCharacterDone()),_p($(`btn-settings`),`Settings`,()=>$(`settings-panel`).classList.toggle(`hidden`)),_p($(`btn-settings-close`),`Close`,()=>$(`settings-panel`).classList.add(`hidden`)),_p($(`btn-toggle-sound`),`Sound`,()=>e.onToggleSound()),_p($(`btn-toggle-mic`),`Mic round`,()=>e.onToggleMic()),_p($(`btn-switch-player`),`Switch player!`,()=>e.onSwitchPlayer()),_p($(`btn-players-back`),`Back`,()=>e.onPlayersBack()),_p($(`btn-new-player-ok`),`Let's go!`,()=>Ap(!0)),_p($(`btn-new-player-skip`),`Let's go!`,()=>Ap(!1)),_p($(`btn-delete-no`),`No`,()=>jp()),_p($(`btn-delete-yes`),`Goodbye!`,()=>Mp()),_p($(`btn-map-back`),`Back`,()=>e.onMapBack()),_p($(`btn-banner-play`),`Here we go!`,()=>e.onBannerPlay()),_p($(`btn-pause`),`Pause`,()=>e.onPause()),_p($(`btn-resume`),`Resume`,()=>e.onResume()),_p($(`btn-pause-map`),`Map`,()=>e.onPauseMap()),$(`btn-repeat-word`).addEventListener(`click`,()=>e.onRepeatWord()),_p($(`btn-play-again`),`Play again!`,()=>e.onPlayAgain()),_p($(`btn-next-level`),`Next level!`,()=>e.onNextLevel()),_p($(`btn-complete-map`),`Map`,()=>e.onCompleteMap()),_p($(`btn-bonus-skip`),`Skip`,()=>e.onBonusSkip()),_p($(`btn-title-house`),`My house!`,()=>e.onHouse(`title`)),_p($(`btn-complete-house`),`My house!`,()=>e.onHouse(`complete`)),_p($(`btn-house-back`),`Back`,()=>e.onHouseBack()),_p($(`btn-house-shop`),`Shop!`,()=>Gp(!0)),_p($(`btn-shop-close`),`Close`,()=>Gp(!1)),Up=e.onBuyItem,vp($(`btn-mic`),e.onMicDown,e.onMicUp),vp($(`btn-move-left`),()=>e.onMoveDown(-1),()=>e.onMoveUp(-1)),vp($(`btn-move-right`),()=>e.onMoveDown(1),()=>e.onMoveUp(1)),vp($(`btn-move-jump`),e.onJumpDown,e.onJumpUp);let t=0;$(`version-tag`).addEventListener(`click`,()=>{t++,t>=5&&(t=0,e.onDevUnlock())})}function _p(e,t,n){e.addEventListener(`click`,()=>{mu(t,{rate:1}),n()})}function vp(e,t,n){let r=e=>{e.preventDefault(),t()},i=e=>{e.preventDefault(),n()};e.addEventListener(`touchstart`,r,{passive:!1}),e.addEventListener(`touchend`,i,{passive:!1}),e.addEventListener(`touchcancel`,i,{passive:!1}),e.addEventListener(`mousedown`,r),e.addEventListener(`mouseup`,i),e.addEventListener(`mouseleave`,i)}function yp(e){for(let t of hp)$(`screen-${t}`).classList.toggle(`hidden`,t!==e);e!==`map`&&Cp(),dp(e||`game`)}function bp(e){$(`hud`).classList.toggle(`hidden`,!e)}function xp(){let e=Fu();$(`btn-toggle-sound`).textContent=e.sound?`🔊 Sound: ON`:`🔇 Sound: OFF`,$(`btn-toggle-mic`).textContent=e.mic?`🎤 Mic Round: ON`:`🎤 Mic Round: OFF`}function Sp({name:e,stars:t,completed:n,secret:r,boss:i}){$(`banner-name`).textContent=r?`✨ ${e} ✨`:i?`👑 ${e} 👑`:e,$(`banner-stars`).textContent=t>0?`⭐`.repeat(t):`· · ·`,$(`btn-banner-play`).textContent=n?`🔁 PLAY`:`▶️ PLAY`,$(`level-banner`).classList.remove(`hidden`)}function Cp(){$(`level-banner`).classList.add(`hidden`)}function wp(){return!$(`level-banner`).classList.contains(`hidden`)}function Tp(e){let t=$(`player-nameplate`);t.textContent=e,t.classList.toggle(`hidden`,!e)}var Ep=null,Dp=null;function Op(e){Ep=e,kp(),yp(`players`)}function kp(){$(`new-player-panel`).classList.add(`hidden`),jp();let e=$(`players-list`);e.innerHTML=``;let t=Tu(),n=t.map(e=>Ou(e.id)),r=mp(n.map(e=>fd(e.character)));if(t.forEach((i,a)=>{let o=i.name||`Player ${a+1}`,s=document.createElement(`div`);s.className=`player-card`+(i.id===Eu()?` active`:``);let c=document.createElement(`img`);c.className=`player-thumb`,c.src=r[a],c.alt=``;let l=document.createElement(`span`);l.className=`player-name`,l.textContent=o;let u=document.createElement(`span`);if(u.className=`player-progress`,u.textContent=`🗺️ World ${n[a].unlocked.world+1}`,s.append(c,l,u),s.addEventListener(`click`,()=>{mu(o,{rate:1}),Ep.onSelect(i.id)}),t.length>1){let e=document.createElement(`button`);e.className=`player-delete`,e.textContent=`✕`,e.addEventListener(`click`,e=>{e.stopPropagation(),mu(`Delete this player? All their progress will be lost.`,{rate:1}),Dp=i.id,$(`confirm-delete-panel`).classList.remove(`hidden`)}),s.appendChild(e)}e.appendChild(s)}),t.length<6){let t=document.createElement(`div`);t.className=`player-card new-player`,t.innerHTML=`<span class="player-plus">➕</span>
      <span class="player-name">New Player</span>
      <span class="player-progress">&nbsp;</span>`,t.addEventListener(`click`,()=>{mu(`New player! What is your name?`,{rate:1}),$(`new-player-name`).value=``,$(`new-player-panel`).classList.remove(`hidden`),$(`new-player-name`).focus()}),e.appendChild(t)}}function Ap(e){if($(`new-player-panel`).classList.contains(`hidden`))return;$(`new-player-panel`).classList.add(`hidden`);let t=e?$(`new-player-name`).value.trim():``;Ep.onCreate(t)}function jp(){Dp=null,$(`confirm-delete-panel`).classList.add(`hidden`)}function Mp(){if(!Dp)return;let e=Dp;jp(),Ep.onDelete(e),kp()}function Np(e){let t=$(`char-rows`);t.innerHTML=``;let n=Fu().character,r=(e,n)=>{let r=document.createElement(`div`);r.className=`char-row`;let i=document.createElement(`div`);i.className=`char-label`,i.textContent=e,r.appendChild(i);let a=document.createElement(`div`);a.className=`char-options`;for(let e of n)a.appendChild(e);r.appendChild(a),t.appendChild(r)},i=(t,n,r)=>{mu(r,{rate:1}),e(t,n),Np(e)};for(let[e,t]of Object.entries(ld))r(t.label,t.colors.map((r,a)=>{let o=document.createElement(`button`);return o.className=`swatch`+(a===n[e]?` selected`:``),o.style.background=`#${r.toString(16).padStart(6,`0`)}`,o.addEventListener(`click`,()=>i(e,a,t.names[a])),o}));let a=(e,t,n)=>r(t.label,t.names.map((r,a)=>{let o=document.createElement(`button`);return o.className=`swatch style-swatch`+(a===n?` selected`:``),o.textContent=t.icons[a],o.title=r,o.addEventListener(`click`,()=>i(e,a,r)),o}));a(`style`,ud,n.style),a(`outfit`,dd,n.outfit)}function Pp(e){$(`coin-count`).textContent=e}function Fp(e){$(`hud-key`).classList.toggle(`hidden`,!e)}function Ip(e){$(`move-controls`).classList.toggle(`hidden`,!e)}function Lp(e){let t=$(`progress-dots`);t.innerHTML=``;for(let n=0;n<e;n++){let e=document.createElement(`div`);e.className=`dot`,t.appendChild(e)}}function Rp(e,t){let n=$(`progress-dots`).children[e];n&&(n.className=`dot ${t}`)}function zp({stars:e,coins:t,gems:n,hasNext:r}){yp(`complete`),$(`complete-coins`).textContent=t,$(`complete-gems`).textContent=n,$(`btn-next-level`).classList.toggle(`hidden`,!r);let i=$(`star-row`).querySelectorAll(`.star`);i.forEach(e=>e.classList.remove(`earned`));for(let t=0;t<e;t++)setTimeout(()=>i[t].classList.add(`earned`),500+t*450)}function Bp(e){$(`bonus-word`).textContent=e,$(`bonus-feedback`).textContent=``}function Vp(e){$(`bonus-feedback`).textContent=e}function Hp(e){$(`btn-mic`).classList.toggle(`listening`,e)}var Up=null,Wp=null;function Gp(e){$(`shop-panel`).classList.toggle(`hidden`,!e),e&&Jp()}function Kp(){yp(`house`),Gp(!1),qp()}function qp(){let e=Fu();$(`house-coins`).textContent=e.coins,$(`house-gems`).textContent=e.gems}function Jp(){qp();let e=Fu(),t=$(`shop-list`);t.innerHTML=``;for(let n of fp){let r=Xu(n.id),i=n.currency===`gems`?e.gems:e.coins,a=document.createElement(`button`);a.className=`shop-item`+(r?` owned`:i<n.cost?` cant-afford`:``);let o=n.currency===`gems`?`💎`:`🪙`;a.innerHTML=`<span class="shop-emoji">${n.emoji}</span>
      <span class="shop-info"><span>${n.name}</span>
      <span class="shop-cost">${r?`✅ Got it!`:`${o} ${n.cost}`}</span></span>`,a.addEventListener(`click`,()=>Up&&Up(n)),t.appendChild(a)}}function Yp(e){let t=$(`house-toast`);t.textContent=e,t.classList.remove(`hidden`),clearTimeout(Wp),Wp=setTimeout(()=>t.classList.add(`hidden`),1800)}var Xp=window.webkitSpeechRecognition||window.SpeechRecognition||null,Zp=null,Qp=!1;function $p(){return!!Xp}function em(e,t){if(!Xp||Qp)return!1;try{return Zp=new Xp,Zp.lang=`en-US`,Zp.interimResults=!0,Zp.maxAlternatives=5,Zp.continuous=!1,Zp.onresult=t=>{let n=[];for(let e=0;e<t.results.length;e++){let r=t.results[e];for(let e=0;e<r.length;e++){let t=(r[e].transcript||``).toLowerCase().replace(/[^a-z'\s]/g,``);for(let e of t.split(/\s+/))e&&n.push(e)}}n.length&&e&&e(n)},Zp.onerror=()=>tm(t),Zp.onend=()=>tm(t),Zp.start(),Qp=!0,!0}catch{return tm(t),!1}}function tm(e){Qp&&(Qp=!1,Zp=null,e&&e())}function nm(){if(Zp)try{Zp.stop()}catch{}Qp=!1}var rm=new URLSearchParams(location.search);rm.has(`reset`)&&id(),Nu(),rm.has(`unlock`)&&ad(Ad.length),Fl(!Fu().sound);var im=Ad.map(e=>e.levels.length),am={world:0,level:0,secret:!1},om=null,sm=null,cm=null,lm=`map`,um=`title`,dm=()=>Pl();window.addEventListener(`pointerdown`,dm,{once:!0}),window.addEventListener(`touchstart`,dm,{once:!0});var fm=document.getElementById(`game-container`),pm=new gl({antialias:!0});pm.setPixelRatio(Math.min(window.devicePixelRatio,2)),pm.setSize(window.innerWidth,window.innerHeight),pm.outputColorSpace=Ve,fm.appendChild(pm.domElement);var mm=new _f(pm,{onCoins:e=>Pp(e),onDotsInit:e=>Lp(e),onDot:(e,t)=>Rp(e,t),onKey:e=>Fp(e),onChoice:e=>Ip(e),onRunComplete:e=>Pm(e)}),hm=new Ff(pm,{onNodeSelected:e=>{om=e,mu(e.name,{rate:1}),Sp(e)},onDismiss:()=>{om=null,Cp()},onEnterKey:()=>{om&&wp()?jm():hm.walkTo(hm.tokenNav)},onHouseTapped:()=>{mu(`My house!`,{rate:1}),Dm(`map`)},onEditTapped:()=>{mu(`Make your character!`,{rate:1}),Tm(`map`)}}),gm=new If,_m=new Xf(pm);window.__wr={game:mm,store:hu,map:hm,charScene:gm,house:_m};var vm=new Za;pm.setAnimationLoop(()=>{let e=Math.min(vm.getDelta(),.05);lm===`game`?(mm.tick(e),pm.render(mm.scene,mm.camera)):lm===`char`?(gm.tick(e),pm.render(gm.scene,gm.camera)):lm===`house`?(_m.tick(e),pm.render(_m.scene,_m.camera)):(hm.tick(e),pm.render(hm.scene,hm.camera))});function ym(){for(let e of[mm.camera,hm.camera,gm.camera,_m.camera])e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix();pm.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,ym),window.addEventListener(`orientationchange`,ym);function bm(){lm=`map`,hm.enter(),bp(!1),yp(`map`)}function xm(){lm===`map`&&hm.exit(),lm=`char`,gm.setLook(wd()),Tp(Du()),yp(`title`)}function Sm(){let e=Fu();Fl(!e.sound);let t=wd();Td(mm.player.group,t),Td(hm.token,t),gm.setLook(t),hm.refresh(),hm.setTokenTo(e.unlocked.world,e.unlocked.level),_m.refresh(),Pp(e.coins),xp(),Tp(Du()),am={world:0,level:0,secret:!1},om=null,sm=null}function Cm(){lm===`map`&&hm.exit(),lm=`char`,mu(`Who's playing?`,{rate:1}),Op({onSelect:e=>{e!==Eu()&&(Au(e),Sm()),xm()},onCreate:e=>{ku(e)&&(Sm(),Tm(`title`))},onDelete:e=>{let t=e===Eu();ju(e),t&&Sm()}})}var wm=`title`;function Tm(e=`title`){wm=e,lm===`map`&&hm.exit(),lm=`char`,gm.setLook(wd()),Np((e,t)=>{od(e,t),gm.setLook(wd())}),yp(`char`)}function Em(){let e=wd();if(Td(mm.player.group,e),Td(hm.token,e),wm===`map`){bm();return}xm()}function Dm(e){um=e,lm===`map`&&hm.exit(),lm=`house`,_m.enter(),bp(!1),Kp()}function Om(){_m.exit(),um===`complete`?Im():um===`map`?bm():xm()}function km(e){if(Xu(e.id)){mu(`You already have the ${e.name}!`,{rate:1});return}if(!Zu(e.id,e.cost,e.currency)){let t=e.currency===`gems`?`gems — try the bonus round`:`coins`;Yp(`🪙 Keep playing!`),mu(`You need more ${t}! Play levels to earn more.`,{rate:1});return}_m.refresh(),_m.celebrate(e.id),Bl(),Jp(),Yp(`${e.emoji} ${e.name}!`),mu(`You got the ${e.name}! ${Ld[Math.random()*Ld.length|0]}`,{rate:1})}function Am(e,t,n=!1){let r=!n&&t===im[e];am={world:e,level:t,secret:n,boss:r},hm.exit(),lm=`game`,mm.startRun(e,t,{secret:n,boss:r}),yp(null),bp(!0)}function jm(){if(!om)return;let e=om;om=null,Cp(),Am(e.world,e.secret?0:e.level,e.secret)}function Mm(e,t){return t+1<=im[e]?{world:e,level:t+1}:e+1<Ad.length?{world:e+1,level:0}:null}function Nm(e){let t=e.length||1,n=e.filter(e=>e.firstTry).length;return n===t?3:n/t>=.7?2:1}function Pm(e){sm=e,bp(!1);let t=Nm(e.results);if(sm.stars=t,am.secret)Gu(am.world,t);else{let n=Hu(am.world,am.level)===0;if(Uu(am.world,am.level,t),td(am.world,am.level,im),am.boss&&ed(am.world),n){let e=Mm(am.world,am.level);e&&nd(e.world,e.level)&&hm.queueReveal({kind:`node`,world:e.world,level:e.level})}e.keyFound&&!Ku(am.world,am.level)&&(qu(am.world,am.level),hm.queueReveal({kind:`secret`,world:am.world}))}$p()&&Fu().mic&&e.results.length?Lm(e):Fm()}function Fm(){let e=am.secret?null:Mm(am.world,am.level);zp({stars:sm.stars,coins:sm.coins,gems:sm.gems,hasNext:!!e&&nd(e.world,e.level)})}function Im(){bm(),hm.setTokenTo(am.world,am.level,am.secret)}function Lm(e){try{cm={words:Md(e.results.map(e=>e.word)).slice(0,3),idx:0,matched:!1,heard:[],advancing:!1},yp(`bonus`),mu(`Bonus round! Read the word out loud. Hold the microphone and say it!`,{rate:1}),Rm()}catch{Bm()}}function Rm(){cm.matched=!1,cm.heard=[],cm.advancing=!1,Bp(cm.words[cm.idx])}function zm(){!cm||cm.advancing||(cm.advancing=!0,nm(),Hp(!1),setTimeout(()=>{cm&&(cm.idx++,cm.idx>=cm.words.length?Bm():Rm())},1400))}function Bm(){cm=null,nm(),Hp(!1),Fm()}function Vm(e){return(e||``).toLowerCase().replace(/[^a-z']/g,``)}function Hm(){if(!cm||cm.advancing)return;let e=Vm(cm.words[cm.idx]);em(t=>{!cm||cm.matched||(cm.heard.push(...t),t.some(t=>Vm(t)===e)&&(cm.matched=!0,cm.heard=[],sm.gems+=5,Vu(5),Bl(),Vp(`⭐ +5 💎`),mu(Ld[Math.random()*Ld.length|0],{rate:1}),zm()))},()=>{Hp(!1),!(!cm||cm.matched||cm.advancing)&&cm.heard.length&&(Vp(`💛 Nice try!`),mu(`Nice try! The word is: ${cm.words[cm.idx]}`,{rate:.9}),zm())})&&Hp(!0)}function Um(){nm(),Hp(!1)}gp({onPlay:()=>{bm(),hm.walkTo(hm.tokenNav)},onCharacter:()=>Tm(),onCharacterDone:()=>Em(),onSwitchPlayer:()=>Cm(),onPlayersBack:()=>xm(),onToggleSound:()=>{let e=!Fu().sound;sd(e),Fl(!e),xp(),e&&zl()},onToggleMic:()=>{cd(!Fu().mic),xp()},onMapBack:()=>xm(),onBannerPlay:()=>jm(),onPause:()=>{mm.pause(),yp(`pause`)},onResume:()=>{yp(null),mm.resume()},onPauseMap:()=>{mm.stopRun(),bm()},onRepeatWord:()=>mm.repeatWord(),onPlayAgain:()=>Am(am.world,am.level,am.secret),onNextLevel:()=>{let e=Mm(am.world,am.level);e&&Am(e.world,e.level)},onCompleteMap:()=>Im(),onBonusSkip:()=>{cm&&(cm.advancing=!0,nm(),cm.idx=cm.words.length,Bm())},onMicDown:Hm,onMicUp:Um,onHouse:e=>Dm(e),onHouseBack:()=>Om(),onBuyItem:e=>km(e),onMoveDown:e=>mm.setMove(`btn`,e,!0),onMoveUp:e=>mm.setMove(`btn`,e,!1),onJumpDown:()=>mm.running&&!mm.paused&&mm.player.jump(),onJumpUp:()=>{},onDevUnlock:()=>{ad(Ad.length),mu(`All levels unlocked!`,{rate:1}),hm.refresh()}}),xp(),hm.enter(),hm.exit(),xm(),document.addEventListener(`visibilitychange`,()=>{document.hidden&&mm.running&&!mm.paused&&(mm.pause(),yp(`pause`))});